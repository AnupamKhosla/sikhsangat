...
(function (e, t, n, r, i) {
  function T(t) {
    ...
    var n = e.trim,
      ...
      u,
      a,
      f = h ? new Float32Array(6) : [],
      l = h ? new Float32Array(6) : [],
      c = h ? new Float32Array(6) : [1, 0, 0, 1, 0, 0];
    f[0] = f[3] = c[0] = c[3] = 1;
    f[1] = f[2] = f[4] = f[5] = 0;
    while (++i < s) {
      o = t[i].split("(");
    ...
    switch (e) {
      ...
      case E:
        t = t
          ? (t = t.split(",")) && [
              parseFloat(t[0]),
              parseFloat(t.length > 1 ? t[1] : e == E ? r || t[0] : n + ""),
            ]
          : [n, n];
        break;
      case S + "X":
  ...
  function M(e) {
    return ~e.indexOf("deg")
      ? parseInt(e, 10) * ((r.PI * 2) / 360)
      : ~e.indexOf("grad")
        ? parseInt(e, 10) * (r.PI / 200)
        : parseFloat(e);
  }
  ...
  var s = n.createElement("div"),
    ...
    d,
    v = /Matrix([^)]*)/,
    m = /^\s*matrix\(\s*1\s*,\s*0\s*,\s*0\s*,\s*1\s*(?:,\s*0(?:px)?\s*){2}\)\s*$/,
    g = "transform",
    y = "transformOrigin",
    b = "translate",
    w = "rotate",
  ...
  if (l && l != g) {
    ...
    if (l == "Moz" + u) {
      p = {
        ...
        set: function (e, t) {
          e.style[l] = /matrix\([^)p]*\)/.test(t)
            ? t.replace(/matrix((?:[^,]*,){4})([^,]*),([^)]*)/, x + "$1$2px,$3px")
            : t;
        },
      };
    ...
    p = {
      get: function (t, n, r) {
        var s = n && t.currentStyle ? t.currentStyle : t.style,
          o,
          u;
      ...
      set: function (t, n, r) {
        ...
        i.filter = v.test(u)
          ? u.replace(v, o)
          : u + " progid:DXImageTransform.Microsoft." + o + ")";
        if (!e.cssHooks[y]) {
          if ((a = e.transform.centerOrigin)) {
            i[a == "margin" ? "marginLeft" : "left"] =
              -(t.offsetWidth / 2) + t.clientWidth / 2 + "px";
            i[a == "margin" ? "marginTop" : "top"] =
              -(t.offsetHeight / 2) + t.clientHeight / 2 + "px";
          }
          i.left = n[4] + "px";
          i.top = n[5] + "px";
        } else {
      ...
      switch (h[0]) {
        ...
        case E:
          ...
          u =
            h[0] +
            "(" +
            r.round((h[1][0] + (v[1][0] - h[1][0]) * o) * a) / a +
            m +
            "," +
            r.round((h[1][1] + (v[1][1] - h[1][1]) * o) * a) / a +
            m +
            ")" +
            u;
          break;
  ...
  var a = (function () {
    ...
    var e = "s",
      ...
      A = function (e, i) {
        ...
        for (var f in n)
          if (n.hasOwnProperty(f)) for (var d = 0; d < A.length; d++) if (A[d] === f) return f;
        return i;
      },
      c = function (e) {
        var s = function () {
      ...
      m = function () {
        var e = n();
        return (
          e || ((e = a.olson.timezones[r()]), "undefined" != typeof s.AMBIGUITIES[e] && (e = c(e))),
          {
            name: function () {
              return e;
            },
...
!(function (d, _) {
  ...
  if (
    ...
    "IntersectionObserverEntry" in d &&
    "intersectionRatio" in d.IntersectionObserverEntry.prototype
  )
    "isIntersecting" in d.IntersectionObserverEntry.prototype ||
      Object.defineProperty(d.IntersectionObserverEntry.prototype, "isIntersecting", {
        get: function () {
    ...
    ((t.prototype.THROTTLE_TIMEOUT = 100),
      ...
      (t.prototype._monitorIntersections = function () {
        this._monitoringIntersections ||
          ...
          this.POLL_INTERVAL
            ...
            : (n(d, "resize", this._checkForIntersections, !0),
      ...
      (t.prototype._unmonitorIntersections = function () {
        this._monitoringIntersections &&
          ...
          o(d, "resize", this._checkForIntersections, !0),
        ...
        if ("none" != d.getComputedStyle(t).display) {
          for (var n, o, i, r, s, h, c, a, u = m(t), l = v(t), p = !1; !p; ) {
            ...
            if (
              (l == this.root || l == _
                ? ((p = !0), (f = e))
                : l != _.body && l != _.documentElement && "visible" != g.overflow && (f = m(l)),
              f &&
                ((n = f),
                (o = u),
                void 0,
      ...
      (d.IntersectionObserver = t),
      (d.IntersectionObserverEntry = a));
  }
...
(function ($, _, undefined) {
  ...
  if (
    ipsDebug ||
    (!_.isUndefined(window.localStorage) &&
    ...
    var boot = function (config) {
        ...
        var newHtml = function (value) {
          ...
          if (typeof value === "string") {
            ...
            var lazyLoadWrapper = elem.closest(
      ...
      _preloadLoader = function () {
        ...
        elem.append(
          $("<span/>").addClass("ipsLoading ipsLoading_noAnim").css({
            display: "block",
          }),
        );
        $("body").append(elem);
        ...
        $(document)
          ...
          .ajaxComplete(function (event, request, settings) {
            ...
            if (!_.isUndefined(settings) && !settings.bypassRedirect) {
              ...
              if (
                !_.isUndefined(request.responseJSON) &&
                !_.isUndefined(request.responseJSON.redirect)
              ) {
        ...
        word = word.replace(/\{(!|\d+?)?#(.*?)\}/g, function (a, b, c, d) {
          ...
          c.replace(/\[(.+?):(.+?)\]/g, function (w, x, y, z) {
            ...
            if (x == "?") {
              ...
              x.charAt(0) == "%" &&
              x.substring(1) == replacement.substring(0, x.substring(1).length)
            ) {
      ...
      testConsole = function () {
        if (window.atob && window.console) {
          console.log(
            window.atob(
              "",
            ),
          );
        }
        return "";
  ...
  !(function (e) {
    ...
    var vt = function (t) {
        for (
          ...
          for (
            var r = V, i = null, s = null, c = 0, l = null, u = -1;
            a < n && (s = r.next(e[a]));
          )
            ((i = null), (r = s), r.accepts() ? ((u = 0), (l = r)) : u >= 0 && u++, c++, a++);
          if (!(u < 0)) {
            ((a -= u), (c -= u));
            var p = l.emit();
      ...
      St = n(wt, l(), {
        ...
        toHref: function () {
          for (
            ...
            ((e = !0), a.push(o[r].toString().toLowerCase()), r++);
    ...
    var ge = function (t) {
        for (var e = t.length, n = 0, o = [], a = []; n < e; ) {
          for (
            var r = At, i = null, s = null, c = 0, l = null, u = -1;
            n < e && !(i = r.next(t[n]));
          )
            a.push(t[n++]);
          for (; n < e && (s = i || r.next(t[n])); )
            ((i = null), (r = s), r.accepts() ? ((u = 0), (l = r)) : u >= 0 && u++, n++, c++);
          if (u < 0) for (var p = n - c; p < n; p++) a.push(t[p]);
          else {
      ...
      for (var i = [], r = e, a = Array.isArray(r), o = 0, r = a ? r : r[Symbol.iterator](); ; ) {
        ...
        if ("nl" === f.type && t.nl2br) i.push(n.createElement("br"));
          ...
          if (h)
            for (var b in h)
              v.addEventListener
                ? v.addEventListener(b, h[b])
                : v.attachEvent && v.attachEvent("on" + b, h[b]);
            ...
            XRegExp.build = function (pattern, subs, flags) {
              ...
              var output = patternAsRegex.source.replace(parts, function ($0, $1, $2, $3, $4) {
                ...
                if (subName) {
                  ...
                  return (
                    intro +
                    data[subName].pattern.replace(subParts, function (match, paren, backref) {
                      if (paren) {
                  ...
                  if (!--openTokens) {
                    if (vN) {
                      if (vN[0] && outerStart > lastOuterEnd) {
                        output.push(
                          row(vN[0], str.slice(lastOuterEnd, outerStart), lastOuterEnd, outerStart),
                        );
                      }
                      if (vN[1]) {
                        output.push(
                          row(vN[1], str.slice(outerStart, innerStart), outerStart, innerStart),
                        );
                      }
                      if (vN[2]) {
                        output.push(
                          row(vN[2], str.slice(innerStart, delimStart), innerStart, delimStart),
                        );
                      }
                      if (vN[3]) {
                        output.push(
                          row(vN[3], str.slice(delimStart, delimEnd), delimStart, delimEnd),
                        );
                      }
                    } else {
            ...
            function (match, scope) {
              if (
                ...
                throw new SyntaxError(
                  "Cannot use octal escape or backreference to undefined group " + match[0],
                );
              }
              return match[0];
            },
  ...
  (function () {
    ...
    function V(a) {
      for (var d = void 0, f = a.firstChild; f; f = f.nextSibling)
        var c = f.nodeType, d = 1 === c ? (d ? a : f) : 3 === c ? (W.test(f.nodeValue) ? a : d) : d;
      return d === a ? void 0 : d;
    }
    ...
    var D = "undefined" !== typeof window ? window : {},
      ...
      F = [
        F,
        "abstract,async,await,constructor,debugger,enum,eval,export,function,get,import,implements,instanceof,interface,let,null,of,set,undefined,var,with,yield,Infinity,NaN",
      ],
      Q = [
        B,
