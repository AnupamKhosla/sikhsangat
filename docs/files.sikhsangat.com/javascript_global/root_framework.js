...
ips.templates.set(
  "core.posts.multiQuoter",
  "  <div id='ipsMultiQuoter'>  <button class='ipsButton ipsButton_veryLight ipsButton_small' data-role='multiQuote'><i class='fa fa-comments'></i> &nbsp;&nbsp;{{{count}}}</button> &nbsp;&nbsp;<a href='#' data-action='clearQuoted'><i class='fa fa-times'></i></a> </div>",
);
ips.templates.set(
  "core.menus.menuItem",
  "  <li class='ipsMenu_item {{#checked}}ipsMenu_itemChecked{{/checked}}' data-ipsMenuValue='{{value}}'>  <a href='{{link}}'>{{title}}</a> </li>",
);
...
ips.templates.set(
  "core.postNotify.single",
  "  <span data-role='newPostNotification' class='ipsType_medium'>  <img src='{{photo}}' alt='' class='ipsUserPhoto ipsUserPhoto_tiny ipsPos_middle'> &nbsp;&nbsp;&nbsp;{{{text}}}  &nbsp;&nbsp;&nbsp;<a href='#' data-action='loadNewPosts'>{{#lang}}showReply{{/lang}}</a> </span>",
);
ips.templates.set(
  "core.postNotify.multiple",
  "  <span data-role='newPostNotification' class='ipsType_medium'>  {{text}}  &nbsp;&nbsp;&nbsp;<a href='#' data-action='loadNewPosts'>{{#lang}}showReplies{{/lang}}</a> </span>",
);
ips.templates.set(
  "core.postNotify.multipleSpillOver",
  "  <span data-role='newPostNotification' class='ipsType_medium'>  {{text}}  {{#canLoadNew}}   &nbsp;&nbsp;&nbsp;<a href='#' data-action='loadNewPosts'>{{showFirstX}}</a>   &nbsp;&nbsp;&nbsp;<span class='ipsType_light'>{{#lang}}showRepliesOr{{/lang}}</span>  {{/canLoadNew}}  &nbsp;&nbsp;&nbsp;<a href='{{spillOverUrl}}'>{{#lang}}goToNewestPage{{/lang}}</a> </span>",
);
ips.templates.set(
  "core.notification.flashSingle",
...
ips.templates.set(
  "core.notification.flashMultiple",
  "  <div class='ipsFlex ipsFlex-ai:center ipsGap:3 ipsGap_row:0 ipsType_medium ipsType_blendLinks' data-role='newNotification'>  <span class='ipsFlex-flex:00 ipsType_veryLarge'><i class='fa fa-bell'></i></span>  <div class='ipsFlex-flex:11 ipsType_left'>   {{text}}   <p class='ipsType_reset ipsType_light ipsTruncate ipsTruncate_line'>{{{body}}}</p>  </div> </div>",
);
ips.templates.set(
  "core.alert.box",
  " <div class='ipsAlert' style='display: none' role='alertdialog' aria-describedby='{{id}}_message'> {{{icon}}} <div class='ipsAlert_msg ipsType_break' id='{{id}}_message'>  <strong>{{{text}}}</strong>  {{{subtext}}} </div> <ul class='ipsToolList ipsToolList_horizontal ipsPos_center ipsAlert_buttonRow ipsClear ipsClearfix'>  {{{buttons}}} </ul></div>",
);
ips.templates.set(
  "core.alert.subText",
...
ips.templates.set(
  "core.alert.prompt",
  " <br><br><input type='text' value='{{value}}' class='ipsField_fullWidth' data-role='promptValue'><br><br>",
);
ips.templates.set("core.lightbox.meta", "{{title}}");
ips.templates.set(
  "core.dialog.main",
  " <div class='{{class}} {{#fixed}}{{class}}_fixed{{/fixed}} {{#size}}{{class}}_{{size}}{{/size}} {{extraClass}}' style='display: none' id='{{id}}' role='dialog' aria-label='{{title}}'> <div>  {{#title}}   <h3 class='{{class}}_title'>{{title}}</h3>   <hr class='ipsHr'>  {{/title}}  {{#close}}   <a href='#' class='{{class}}_close' data-action='dialogClose'>&times;</a>  {{/close}}  <div class='{{class}}_content'>   {{content}}  </div>  <div class='{{class}}_loading {{class}}_large ipsLoading ipsLoading_noAnim' style='display: none'></div> </div></div>",
);
ips.templates.set(
  "core.tooltip",
...
ips.templates.set(
  "core.editor.emoticonNoResults",
  "  <div class='ipsPad ipsType_center ipsType_light'>{{#lang}}no_results{{/lang}}</div>",
);
ips.templates.set(
  "core.editor.emojiResult",
  "  <li class='ipsMenu_item ipsCursor_pointer' title='{{name}}' data-emoji='{{code}}'>  <a><span class='ipsEmoji_result'>{{{emoji}}}</span> <span data-role='shortCode'>{{short_code}}</span></a> </li>",
);
ips.templates.set(
  "core.editor.quote",
  "<blockquote class='ipsQuote' data-ipsQuote data-gramm='false'><div class='ipsQuote_citation'>{{citation}}</div><div class='ipsQuote_contents ipsClearfix' data-gramm='false'>{{{contents}}}</div></blockquote>",
);
ips.templates.set(
  "core.editor.legacyQuoteUpcast",
  "<div class='ipsQuote_citation'>{{citation}}</div><div class='ipsQuote_contents ipsClearfix' data-gramm='false'>{{{contents}}}</div>",
);
ips.templates.set(
  "core.editor.citation",
  "  <div class='ipsQuote_citation ipsQuote_open'>  <a href='#' data-action='toggleQuote'>&nbsp;</a>  {{#contenturl}}   <a class='ipsPos_right' href='{{contenturl}}'><i class='fa fa-share'></i></a>  {{/contenturl}}  {{{citation}}} </div>",
);
ips.templates.set(
  "core.editor.citationLink",
...
ips.templates.set(
  "core.autocomplete.field",
  "  <div class='ipsField_autocomplete' id='{{id}}_wrapper' role='combobox' aria-autocomplete='list' aria-owns='{{id}}_results'>  <span class='ipsField_autocomplete_loading' style='display: none' id='{{id}}_loading'></span>  <ul class='ipsList_inline' role='listbox'><li id='{{id}}_inputItem' role='option'>{{content}}</li></ul> </div>",
);
ips.templates.set(
  "core.autocomplete.addToken",
  "  <a href='#' data-action='addToken'><i class='fa fa-plus'></i> {{text}}</a> ",
);
ips.templates.set(
  "core.autocomplete.resultWrapper",
  "  <div class='ipsAutocompleteMenu' id='{{id}}_results' aria-expanded='false' style='display: none'>  <ul class='ipsAutocompleteMenu_itemWrapper ipsList_reset' role='listbox' aria-expanded='false' data-role='items'></ul> </div>",
);
ips.templates.set(
  "core.autocomplete.searchTypeAhead",
  "  <div class='ipsPad_half ipsAreaBackground' data-role='autocompleteSearch'>  <div class='ipsClearfix'>   <input type='search' name='autocompleteSearch' placeholder='{{#lang}}autocomplete_search_placeholder{{/lang}}'>  </div> </div>",
);
ips.templates.set(
  "core.autocomplete.resultItem",
  "  <li class='ipsAutocompleteMenu_item' data-value='{{value}}' role='option'>  <div class='ipsClearfix'>   {{html}}  </div> </li>",
);
ips.templates.set(
  "core.autocomplete.tagsResultItem",
  "  <li class='ipsAutocompleteMenu_item' data-value='{{value}}' role='option'>  <div class='ipsClearfix'>   {{html}}   {{#recommended}}    <span class='ipsPos_right ipsType_success'>{{#lang}}tag_recommended{{/lang}}   {{/recommended}}  </div> </li>",
);
ips.templates.set(
  "core.autocomplete.token",
  "  <li class='cToken' data-value='{{value}}' role='option'>  {{{title}}} <span class='cToken_close' data-action='delete'>&times;</span> </li>",
);
ips.templates.set(
  "core.autocomplete.memberItem",
  "  <li class='ipsAutocompleteMenu_item ipsClearfix' data-value=\"{{value}}\" role='option'>  <div class='ipsPhotoPanel ipsPhotoPanel_tiny'>   <span class='ipsUserPhoto ipsUserPhoto_tiny'><img src='{{{photo}}}'></span>   <div>    <strong>{{{name}}}</strong><br>    <span class='ipsType_light'>{{{extra}}}</span>   </div>  </div> </li>",
);
ips.templates.set(
  "core.autocomplete.optional",
  "  <a href='#' data-action='showAutocomplete' class='ipsButton ipsButton_light ipsButton_verySmall'>{{langString}}...</a>",
);
ips.templates.set(
  "core.forms.toggle",
  "  <span class='ipsToggle {{className}}' id='{{id}}' tabindex='0' role='switch' aria-checked='{{status}}'>  <span data-role='status'></span> </span>",
);
ips.templates.set(
  "core.forms.validationWrapper",
...
ips.templates.set(
  "core.forms.advicePopup",
  "<div class='ipsHovercard' data-role='advicePopup' id='elPasswordAdvice_{{id}}'> <div class='ipsPad'>  <h2 class='ipsType_sectionHead'>{{#lang}}password_advice_title{{/lang}}</h2>  <p class='ipsSpacer_top ipsSpacer_half ipsType_reset ipsType_medium'>   {{#min}}    {{min}}    {{/min}}   {{{text}}}  </p> </div> <span class='ipsHovercard_stem'></span></div>",
);
ips.templates.set(
  "core.forms.validateOk",
  "<span> <i class='fa fa-check-circle ipsType_success'></i></span>",
);
ips.templates.set(
  "core.forms.validateFail",
  "<span data-ipsTooltip data-ipsTooltip-label='{{message}}'> <i class='fa fa-times-circle ipsType_warning'></i></span>",
);
ips.templates.set(
  "core.forms.validateFailText",
  "<p class='ipsType_reset ipsSpacer_top ipsSpacer_half ipsType_warning'> <i class='fa fa-times-circle'></i> {{message}}</p>",
);
ips.templates.set(
  "core.truncate.expand",
  "  <a class='ipsTruncate_more' data-action='expandTruncate'><span>{{text}} &nbsp;<i class='fa fa-caret-down'></i></span></a>",
);
ips.templates.set(
  "core.selectTree.token",
...
ips.templates.set(
  "core.infScroll.loading",
  "  <li class='ipsPad ipsType_center' data-role='infScroll_loading'>  {{#lang}}loading{{/lang}}... </li>",
);
ips.templates.set(
  "core.infScroll.pageBreak",
  "  <li class='ipsPad_half ipsAreaBackground' data-role='infScroll_break' data-infScrollPage='{{page}}'>  {{#lang}}page{{/lang}} {{page}} </li>",
);
ips.templates.set(
  "core.pageAction.actionMenuItem",
  "  <li data-role='actionMenu' data-action='{{action}}' id='{{id}}_{{action}}' data-ipsMenu data-ipsMenu-above='force' data-ipsMenu-appendTo='#{{id}}_bar' data-ipsMenu-activeClass='ipsPageAction_active' data-ipsTooltip title='{{title}}' class='ipsHide'>  {{#icon}}   <i class='fa fa-{{icon}} ipsPageAction_icon'></i> <i class='fa fa-caret-up'></i>  {{/icon}}  {{^icon}}   <span class='ipsPageAction_text'>{{title}} <i class='fa fa-caret-up'></i></span>  {{/icon}}  <ul id='{{id}}_{{action}}_menu' class='ipsMenu ipsMenu_auto' style='display: none'>   {{{menucontent}}}  </ul> </li>",
);
ips.templates.set(
  "core.pageAction.actionItem",
  "  <li data-role='actionButton' data-action='{{action}}' id='{{id}}_{{action}}' data-ipsTooltip title='{{title}}'>  {{#icon}}   <i class='fa fa-{{icon}} ipsPageAction_icon' data-ipsTooltip='{{title}}'></i></i>  {{/icon}}  {{^icon}}   <span class='ipsPageAction_text'>{{title}}</span>  {{/icon}} </li>",
);
ips.templates.set(
  "core.pageAction.wrapper",
  "  <div class='ipsPageAction' data-role='actionBar' id='{{id}}_bar'>  <ul class='ipsList_inline ipsList_reset' data-role='actionItems'>   <li>{{{selectedLang}}}</li>   {{{content}}}  </ul> </div>",
);
ips.templates.set(
  "core.carousel.bulletWrapper",
  " <ul class='ipsCarousel_bullets'>{{content}}</ul>",
);
ips.templates.set("core.carousel.bulletItem", " <li><i class='fa fa-circle'></i></li>");
ips.templates.set(
  "core.rating.wrapper",
  " <div class='ipsClearfix ipsRating'>  <ul class='{{className}}' data-role='ratingList'>   {{{content}}}  </ul> </div> <span data-role='ratingStatus' class='ipsType_light ipsType_medium'>{{status}}</span>",
);
ips.templates.set(
  "core.rating.star",
    ...
    var register = function (id, definition) {
      ...
      initControllerOnElem = function (elem, controllerID, mixins) {
        ...
        if (mixins.length) {
          for (var i = 0; i < mixins.length; i++) {
            if (
              !_.isUndefined(_manualMixins[controllerID]) &&
              !_.isUndefined(_manualMixins[controllerID][mixins[i]])
            ) {
      ...
      getBaseController = function () {
            ...
            _.bind(function (type) {
              this[type] = function (base, fn) {
                if (_.isUndefined(this[base]) || !_.isFunction(this[base])) {
                  Debug.log(
                    "Method '" + base + '" is not present in controller ' + this.controllerID,
                  );
                  return;
                }
        ...
        baseController.method("on", function (elem, ev, delegate, fn) {
          var args = ips.utils.argsToArray(arguments);
          elem =
            !_.isElement(elem) && elem != document && elem != window ? this.scope : $(args.shift());
          ev = args[0];
  ...
  ips.createModule("ips.ui", function () {
    ...
    var registerWidget = function (widgetID, handler, acceptedOptions, widgetOptions, fnCallback) {
      ...
      buildjQueryPlugin = function (widgetID, handler, acceptedOptions, widgetOptions) {
        var jQueryKey =
            widgetOptions.jQueryKey || "ips" + widgetID.charAt(0).toUpperCase() + widgetID.slice(1),
          dataID = "ips" + widgetID;
        if ($.fn[jQueryKey]) {
      ...
      _doLazyWidgets = function (widgetsToLoad) {
        ...
        for (var i = 0; i < widgetsToLoad.length; i++) {
          ...
          $(document).on(
            lazyEvents,
            "[data-ips" + widgetsToLoad[i] + "]",
            _.partial(function (widgetKey, e) {
      ...
      _getWidgetOptions = function (widgetID, elem) {
        ...
        try {
          ...
          Debug.warn(
            "Invalid options object passed in for a " + widgetID + " widget. Must be valid JSON.",
          );
        }
        ...
        $(document).on("contentChange", function (e, newContent) {
          if (newContent instanceof jQuery) {
            newContent.each(function () {
              if (Debug.isEnabled) {
                Debug.info(
                  "contentChange event, reinitializing widgets in " + $(this).identify().attr("id"),
                );
              }
            ...
            if (Debug.isEnabled) {
              Debug.info(
                "contentChange event, reinitializing widgets in " +
                  $(newContent).identify().attr("id"),
              );
            }
...
(function ($, _, undefined) {
  ...
  ips.createModule("ips.ui.addressForm", function () {
    ...
    var countryChange = function (elem, options, e) {
      ips
        .getAjax()(
          ips.getSetting("baseURL") +
            "index.php?app=core&module=system&controller=ajax&do=states&country=" +
            $(e.target).val(),
        )
        .done(function (response) {
          if (response.length) {
            ...
            if (!options.requireFullAddress) {
              regionSelect.append(
                $("<option />")
                  .attr("value", "")
                  .html($(elem).find('[data-role="regionText"]').attr("placeholder")),
              );
            }
            ...
            if (!$(elem).find('[data-role="regionText"]').length) {
              ...
              var regionText = $(
                '<input type="text" data-role="regionText" placeholder="' +
                  ips.getString("address_region") +
                  '" />',
              );
      ...
      if (
        typeof elem.attr("data-ipsAddressForm-googlePlaces") !== typeof undefined &&
        elem.attr("data-ipsAddressForm-googlePlaces") !== false
      ) {
          ...
          if (typeof google === "undefined") {
            ips.loader.get([
              "https://maps.googleapis.com/maps/api/js?key=" +
                elem.attr("data-ipsAddressForm-googleApiKey") +
                "&libraries=places&sensor=false&callback=ips.ui.addressForm.googlePlacesCallback",
            ]);
    ...
    var recalculateAddAddressLineButton = function (elem) {
      ...
      var button = $(
        '<i class="fa fa-plus" style="cursor:pointer; margin-left: 4px" data-role="addAddressLine">',
      );
    ...
    ips.ui.registerWidget("addressForm", ips.ui.addressForm, [
      "minimize",
      "country",
      "requireFullAddress",
    ]);
    ...
    var init = function () {
      ...
      _buildAlert = function () {
        ...
        switch (options.type) {
          case "alert":
            buttons.push(
              ips.templates.render("core.alert.button", {
                action: "ok",
    ...
    var respond = function (elem, options) {
      ...
      getObj = function (elem) {
        ...
        if (elem.data("_autocomplete")) {
          ...
          $('[name="' + elem.attr("name") + "_original" + '"]').length &&
          $('[name="' + elem.attr("name") + "_original" + '"]').data("_autocomplete")
        ) {
  ...
  var autocompleteObj = function (elem, options, e) {
    ...
    var init = function () {
        if ($(elem).is('textarea, input[type="text"], input[type="search"]')) {
          ...
          originalTextField = $(elem)
            .find('textarea, input[type="text"], input[type="search"]')
            .first();
        }
        try {
      ...
      _buildWrapper = function () {
        ...
        $(elem)
          .after(
            ips.templates.render(options.fieldTemplate, {
              id: elemID,
            }),
          )
      ...
      _getDataSource = function () {
        if (
          (options.dataSource &&
            options.dataSource.indexOf("#") === 0 &&
            $(options.dataSource).length) ||
          originalTextField.is("[list]")
        ) {
          dataSource = localData(
            originalTextField.is("[list]")
              ? $("#" + originalTextField.attr("list"))
              : options.dataSource,
            options,
          );
      ...
      _clickWrapper = function (e) {
        if ($(e.target).is("[data-token]") || $(e.target).parents("li[data-token]").length) {
          ...
          if (
            ...
            (!resultsElem || !$.contains(resultsElem.get(0), e.target))
          ) {
            textField.focus();
          }
        }
      ...
      _keydownField = function (e) {
        ...
        if (
          _([ips.ui.key.ENTER, ips.ui.key.TAB]).contains(e.which) &&
          options.unique &&
      ...
      _keyupField = function (e) {
        ...
        for (i in options.disallowedCharacters) {
          if (textField.val().indexOf(options.disallowedCharacters[i]) !== -1) {
            ...
            _showTooltip(
              ips.getString("ac_prohibit_special", {
      ...
      _keypressField = function (e) {
        ...
        if (
          e.charCode == options.itemSep.charcode &&
          options.unique &&
          _duplicateValue(textField.val())
        ) {
          e.preventDefault();
          _showTooltip(ips.getString("ac_dupes"));
          return;
      ...
      _addToken = function (value) {
        ...
        if (
          options.unique &&
          options.freeChoice == false &&
          dataSource.totalItems() !== -1 &&
          dataSource.totalItems() <= tokens.total()
        ) {
      ...
      tokens = {
        ...
        add: function (value) {
          ...
          tokens.deselectAll();
          inputItem.before(
            ips.templates.render(options.tokenTemplate, {
              id: elemID,
              value: value,
              title: value,
            }),
      ...
      _expandField = function () {
        ...
        widthOfElem -=
          parseInt(wrapper.css("padding-left")) + parseInt(wrapper.css("padding-right"));
        var span = $("<span/>")
          .text(text)
          .css({
    ...
    var getResults = function (text) {
      ...
      _remoteSearch = function (text) {
        ...
        if (cache[text]) {
          ...
          ajaxObj = ips
            .getAjax()(source + "&" + options.queryParam + "=" + encodeURIComponent(text), {
              dataType: "json",
            })
            .done(function (response) {
  ...
  ips.createModule("ips.ui.captcha", function () {
    ...
    var respond = function (elem, options) {
      ...
      _recaptcha = function (elem, options) {
        ips.loader
          .get([document.location.protocol + "//www.google.com/recaptcha/api/js/recaptcha_ajax.js"])
          .done(function () {
            var container = $("<div/>");
      ...
      _recaptcha2 = function (elem, options) {
        ips.loader.get([
          "https://www.google.com/recaptcha/api.js?hl=" +
            $(elem).attr("data-ipsCaptcha-lang") +
            "&onload=recaptcha2Callback&render=explicit",
        ]);
  ...
  ips.createModule("ips.ui.carousel", function () {
    ...
    var carouselObj = function (elem, options) {
      ...
      var init = function () {
          ...
          var startPos = rtlMode
            ? parseInt(ui.itemList.css("right"))
            : parseInt(ui.itemList.css("left"));
          if (!_.isNaN(startPos)) {
        ...
        _build = function () {
          ...
          elem.find(".ipsCarousel_inner").css({
            height:
              maxHeight +
              (parseInt(elem.find(".ipsCarousel_inner").css("padding-top")) +
                parseInt(elem.find(".ipsCarousel_inner").css("padding-bottom"))) +
              "px",
          });
        ...
        _navNext = function (e) {
          ...
          var nextFirst = _.find(items, function (item, idx) {
            ...
            if (rtlMode) {
              ...
              if (
                endEdge == stayOnScreen ||
                (startEdge == stayOnScreen && endEdge > adjustedStartPos)
              ) {
                forceNext = true;
              }
              ...
              if (
                endEdge == stayOnScreen ||
                (startEdge == currentStartPos && endEdge > stayOnScreen)
              ) {
                forceNext = true;
              }
              if (startEdge < stayOnScreen && endEdge > stayOnScreen) {
          ...
          if (rtlMode) {
            ...
            var nextFirstPos =
              ui.itemList.outerWidth() -
              (nextFirst.position().left + nextFirst.outerWidth()) -
              nextFirstMargin;
          } else {
        ...
        _navPrev = function (e, backToBeginning) {
          ...
          var prevFirst = _.find(items, function (item) {
            ...
            if (
              stayOnScreen <= endEdge + margin ||
              (startEdge < idealStartPos && endEdge > idealStartPos)
            ) {
              forcePrev = true;
              return false;
            }
        ...
        _checkNav = function () {
          ...
          if (
            (!rtlMode && Math.floor(list.right) <= Math.floor(container.right)) ||
            (rtlMode && Math.floor(list.left) >= Math.floor(container.left))
          ) {
            ...
            $(this)
              ...
              .each(function (idx) {
                if (headerTypes[idx] == "number") {
                  ...
                  headerTypes[idx] == "date" ||
                  headerTypes[idx] == "datetime" ||
                  headerTypes[idx] == "timeofday"
                ) {
    ...
    var respond = function (elem, options) {
      ...
      getObj = function (elem) {
        ...
        if (elem.data("_contentItem")) {
          ...
          $('[name="' + elem.attr("name") + "_original" + '"]').length &&
          $('[name="' + elem.attr("name") + "_original" + '"]').data("_contentItem")
        ) {
  ...
  var contentItemObj = function (elem, options, e) {
    ...
    var init = function () {
      ...
      _keydownField = function (e) {
        ...
        var ignoreKey = false;
        if (
          !_([ips.ui.key.UP, ips.ui.key.DOWN, ips.ui.key.ESCAPE, ips.ui.key.ENTER]).contains(
            e.keyCode,
          )
        ) {
          ignoreKey = true;
      ...
      contentItems = {
        ...
        add: function (elem) {
          ...
          itemListWrapper.append(
            ips.templates.render(options.itemTemplate, {
      ...
      _buildDialog = function () {
        ...
        if (options.close) {
          ...
          dialog.on("click", function (e) {
            Debug.log(e.target);
            if (
              (!modalEvent.up || (dialog.get(0) == e.target && modalEvent.down)) &&
        ...
        ips
          ...
          .done(function (response, status, jqXHR) {
            if (options.remoteVerify && !form.attr("data-bypassValidation")) {
              if (
                jqXHR.getAllResponseHeaders().indexOf("X-IPS-FormError: true") !== -1 ||
                jqXHR.getAllResponseHeaders().indexOf("X-IPS-FormNoSubmit: true") !== -1 ||
                jqXHR.getAllResponseHeaders().indexOf("x-ips-formerror: true") !== -1 ||
                jqXHR.getAllResponseHeaders().indexOf("x-ips-formnosubmit: true") !== -1
              ) {
...
(function ($, _, undefined) {
  ...
  ips.createModule("ips.ui.editor", function () {
    ...
    var respond = function (elem, options) {
        var loadTries = 0;
        var fileToLoad =
          ips.getSetting("useCompiledFiles") !== true
            ? "core/dev/ckeditor/ckeditor.js"
            : "core/interface/ckeditor/ckeditor/ckeditor.js";
        if (!options.minimized || ips.getSetting("memberID")) {
          ...
          $(elem).data("_editorInit", function (callback) {
            $(elem)
              ...
              .html(ips.templates.render("core.editor.initLoading"));
  ...
  var editorObj = function (elem, options) {
    ...
    var init = function (callback) {
      var config = {
        ...
        title:
          window.navigator.platform == "MacIntel"
            ? ips.getString("editorRightClickMac")
            : ips.getString("editorRightClick"),
      ...
      if (options.pasteBehaviour == "force") {
        ...
        if (CKEDITOR.env.webkit) {
          ...
          config.pasteFilter =
            tags.join(" ") +
            "[*]{background-color,border*,color,padding,text-align,vertical-align,font-size}";
        } else {
      ...
      if (
        ips.getSetting("ipb_url_filter_option") == "none" &&
        ips.getSetting("url_filter_any_action") == "moderate" &&
        ips.getSetting("bypass_profanity") == 0
      ) {
      ...
      if (minimized) {
        var _unminimize = function () {
          ...
          if (minimizedUploader.length) {
            ...
            ips
              .getAjax()(elem.parentsUntil("", "form").attr("action"), {
                data: {
    ...
    var insertQuotes = function (quotes) {
      var _doInsert = function () {
        for (var i = 0; i < quotes.length; i++) {
          var data = quotes[i];
          var regex = /data-ipsLightbox(-group)?="([\w]+)?"/gi;
          var html = data.quoteHtml.replace(regex, "");
          var quote = $(
            ips.templates.render("core.editor.quote", {
      ...
      if (align) {
        if (selectedElement.parent().prop("tagName") === "A") {
          selectedElement
            .parent()
            .css("float", align)
            .removeClass(alignClasses)
            .addClass("ipsAttachLink ipsAttachLink_" + align);
        } else {
          selectedElement
            .css("float", align)
            .removeClass(alignClasses)
            .addClass("ipsAttachLink_image ipsAttachLink_" + align);
        }
      } else {
    ...
    var _deleteFile = function (e, data) {
      ...
      $.each(images, function () {
        var image = $(this);
        if (
          image.attr("data-fileid") == data.fileElem.attr("data-fileid") ||
          image.children("a").attr("data-fileid") == data.fileElem.attr("data-fileid")
        ) {
          toRemove.push(image);
        }
      });
      $.each(links, function () {
        var link = $(this);
        if (
          link.attr("data-fileid") == data.fileElem.attr("data-fileid") ||
          link.attr("href") ==
            ips.getSetting("baseURL") +
              "applications/core/interface/file/attachment.php?id=" +
              data.fileElem.attr("data-fileid")
        ) {
          link.remove();
        }
      });
    ...
    var _scrollToEditor = function () {
      ...
      if (
        elemPosition.absPos.top < windowScroll ||
        elemPosition.absPos.top > windowScroll + viewHeight
      ) {
        $("html, body").animate({
    ...
    var _insertEmoji = function (e, data) {
      try {
        if (_belongsToThisEditor(data)) {
          ...
          if (
            element.getName() == "img" &&
            $("<div>" + instance.getData() + "</div>").find("img[data-emoticon]").length >= 75
          ) {
            var emoMessage = $(elem)
              .closest("[data-ipsEditor]")
              .find('[data-role="emoticonMessage"]');
    ...
    var _buildAndShowPreview = function () {
      ...
      var iframe = $("<iframe />")
        ...
        .attr(
          "src",
          ips.getSetting("baseURL") +
            "index.php?app=core&module=system&controller=editor&do=preview&editor_id=" +
            name,
        )
      ...
      elem.find('[data-role="previewContainer"]').append(
        iframe.css({
  ...
  var filterBarObj = function (elem, options) {
    ...
    var init = function () {
      ...
      _switchToggle = function (e) {
        ...
        _switchView(
          $(e.currentTarget).attr("data-switchTo") == "filterBar" ? "filterBar" : "filterContent",
        );
      },
      _switchView = function (switchTo) {
        ...
        elem.css({
          height:
            currentlyShowing == "filterBar"
              ? filterBar.outerHeight()
              : filterContent.outerHeight() + "px",
        });
      ...
      _cancel = function () {
        elem
          .find('[data-role="filterBar"], [data-role="filterContent"]')
  ...
  ips.createModule("ips.ui.flashMsg", function () {
    ...
    var respond = function (elem, options) {
      ...
      _initElement = function () {
        ...
        _content = _box.is('[data-role="flashMessage"]')
          ? _box
          : _box.find('[data-role="flashMessage"]');
  ...
  ips.createModule("ips.ui.form", function () {
    ...
    var init = function () {
        ...
        $(document).on("codeMirrorInsert", function (e, data) {
          if (!_.isUndefined(_cmInstances[data.elemID])) {
            _cmInstances[data.elemID].replaceRange(
              data.tag,
              _cmInstances[data.elemID].getCursor("end"),
            );
          }
        });
        $(document).on("tabChanged", function (e, data) {
          ...
          if ($("input[name=" + form.attr("data-formId") + "_activeTab]").length) {
            $("input[name=" + form.attr("data-formId") + "_activeTab]").val(
              data["tabID"].replace(form.attr("data-formId") + "_tab_", ""),
            );
          }
        });
      },
    ...
    var _controlMethods = {
        codemirror: function (elem) {
          ips.loader
            .get([
              "core/interface/codemirror/diff_match_patch.js",
              "core/interface/codemirror/codemirror.js",
            ])
            .then(function () {
              ...
              if ($(elem).attr("data-height")) {
                ...
                $("div[data-codemirrorid=" + elemId + "] ul[data-role=tagsList]").css(
                  "max-height",
              ...
              $("[data-codemirrorcustomtag]").on("click", function (e) {
                _cmInstances[elemId].replaceRange(
                  $(e.currentTarget).attr("data-codemirrorcustomtag"),
                  _cmInstances[elemId].getCursor("end"),
                );
              });
            });
        },
            ...
            ips.loader.get(["core/interface/jquery/jquery-ui.js"]).then(function () {
              var _buildDatepicker = function () {
                $.datepicker.regional["xx"] = {
                  ...
                  monthNames: [
                    ips.getString("month_0"),
                    ips.getString("month_1"),
                    ips.getString("month_2"),
                    ips.getString("month_3"),
                    ips.getString("month_4"),
                    ips.getString("month_5"),
                    ips.getString("month_6"),
                    ips.getString("month_7"),
                    ips.getString("month_8"),
                    ips.getString("month_9"),
                    ips.getString("month_10"),
                    ips.getString("month_11"),
                  ],
                  monthNamesShort: [
                    ips.getString("month_0"),
                    ips.getString("month_1"),
                  ...
                  dayNamesShort: [
                    ips.getString("day_0_short"),
                    ips.getString("day_1_short"),
                    ips.getString("day_2_short"),
                    ips.getString("day_3_short"),
                    ips.getString("day_4_short"),
                    ips.getString("day_5_short"),
                    ips.getString("day_6_short"),
                  ],
                  dayNamesMin: [
                    ips.getString("day_0_short"),
                    ips.getString("day_1_short"),
        ...
        granularCheckboxset: function (elem) {
          elem.find('[data-role="checkboxsetUnlimitedToggle"]').on("change", function () {
            if ($(this).is(":checked")) {
              elem
                .find('[data-role="checkboxsetGranular"] input:enabled[type="checkbox"]')
                .prop("checked", $(this).is(":checked"));
            } else {
              elem
                .find('[data-role="checkboxsetGranular"] input[type="checkbox"]')
                .prop("checked", $(this).is(":checked"));
            }
          });
      ...
      _toggler = function (elem, form, toggleList, toggleOn) {
        ...
        if (
          triggerElem.is(":visible") ||
          (triggerElem.attr("data-toggle-visibleCheck") &&
            $(triggerElem.attr("data-toggle-visibleCheck")).is(":visible"))
        ) {
          toCall.call(this, triggerElem, selectorList, elem, form, reverse);
        }
      },
      ...
      _toggleCheckbox = function (elem, toggleList, thisElem, form, reverse) {
        ...
        if (elem.is('[data-control~="unlimited"]') && !elem.is(":checked")) {
          var inputs = elem
            .closest('.ipsFieldRow_content,[data-role="unlimitedCatch"]')
            .find('input[type="radio"],select');
          if (inputs.length) {
            inputs.each(function () {
              var toggle = $(this);
              if (toggle.is("select")) {
                var toggleList = _.difference(
                  toggleList,
                  toggle.find("option:selected").attr("data-toggles"),
                );
      ...
      _toggleNode = function (nodeElem, toggleList, thisElem, form) {
        ...
        nodeElem
          .find('[data-action="nodeSelect"][data-toggles].ipsSelectTree_selected')
          .each(function (idx, elem) {
            _showFormRows(ips.utils.getIDsFromList($(this).attr("data-toggles")), form);
          });
      },
      ...
      _unlimitedCheck = function (checkbox) {
        var inputs = checkbox
          .closest('.ipsFieldRow_content,[data-role="unlimitedCatch"]')
          .find('input:not([type="checkbox"],[type="hidden"]),select,textarea');
      ...
      var init = function () {
        ...
        _equalHeights = function () {
          ...
          if (options.equalHeights == "row") {
            ...
            var idx = 0;
            if (
              (elem.hasClass("ipsGrid_collapsePhone") && ips.utils.responsive.currentIs("phone")) ||
  ...
  ips.createModule("ips.ui.hovercard", function () {
    ...
    var respond = function (elem, options) {
        ...
        if (options.onClick) {
          $(elem)
            .off(".hovercard")
            .on("click.hovercard", function (e) {
              e.preventDefault();
              $(elem).data("_hover").start();
            });
        } else {
          if (
            ips.utils.events.isTouchDevice() &&
            (ips.utils.responsive.currentIs("phone") || ips.utils.responsive.currentIs("tablet"))
          ) {
            return;
          }
          $(elem).data("_hover").start();
    ...
    var init = function () {
      ...
      start = function () {
        ...
        if (!options.onClick) {
          ...
          $(document)
            .off("click." + elemID)
            .on("click." + elemID, _documentClick);
          _startShow();
        }
      },
      ...
      _positionCard = function (showImmediate) {
        ...
        card
          ...
          .addClass(
            options.className +
              "_stem" +
              (location.location.vertical.charAt(0).toUpperCase() +
                location.location.vertical.slice(1)),
          );
        if (tooWide) {
          stem.css({
          ...
          card.addClass(
            options.className +
              "_stem" +
              (location.location.horizontal.charAt(0).toUpperCase() +
                location.location.horizontal.slice(1)),
          );
        }
        if (showImmediate) {
          card.show();
        ...
        ajaxObj = ips
          ...
          .fail(function (jqXHR, status, errorThrown) {
            if (Debug.isEnabled()) {
              ...
              if (status != "abort") {
                content = $("<div/>")
                  .addClass("ipsPad_half ipsType_light")
                  .html(ips.getString("errorLoadingContent"));
                deferred.resolve();
              } else {
                deferred.reject();
              }
      ...
      _buildLoadingWidget = function () {
        ...
        loading = $("<div/>")
          .addClass("ipsHovercard_loading")
          .html(ips.templates.render("core.hovercard.loading"));
    ...
    var infiniteScrollObj = function (elem, options) {
      ...
      var init = function () {
        ...
        _scrollEvent = function (e) {
          if (
            ips.utils.responsive.enabled() &&
            _.indexOf(options.disableIn, ips.utils.responsive.getCurrentKey()) !== -1
          ) {
            return;
          }
        ...
        _loadMoreResults = function () {
          ...
          ajaxObj = ips
            .getAjax()(_getPageURL(currentPage + 1))
            .done(function (response) {
              currentPage++;
        ...
        _getPageURL = function (pageNo) {
          return (
            elem.attr("data-ipsInfScroll-url") + "&" + options.pageParam + "=" + parseInt(pageNo)
          );
        },
  ...
  var lightboxObj = function (elem, options, e) {
    ...
    var init = function () {
      ...
      _showImage = function (image) {
        ...
        if (image.meta) {
          pieces.metaPanel.show().html(
            ips.templates.render("core.lightbox.meta", {
      ...
      _buildWrapper = function () {
        ...
        pieces.lightbox
          .append(pieces.imagePanel.append(pieces.next).append(pieces.prev).append(pieces.fullSize))
  ...
  ips.createModule("ips.ui.map", function () {
    ...
    var _mapbox = function (elem, options) {
      ...
      var handlePopup = function (e) {
        ...
        ips
          .getAjax()(options.contentUrl + clubID)
          .done(function (response) {
    ...
    var _google = function (elem, options) {
      if (typeof google === "undefined" || typeof google.maps === "undefined") {
        ips.loader.get([
          "https://maps.googleapis.com/maps/api/js?key=" +
            ips.getSetting("mapApiKey") +
            "&libraries=places&sensor=false&callback=ips.ui.map.googleCallback",
        ]);
      } else {
        ...
        for (var id in markers) {
          ...
          if (options.contentUrl) {
            marker.addListener("click", function () {
              ...
              ips
                .getAjax()(options.contentUrl + this.id)
                .done(function (response) {
  ...
  ips.createModule("ips.ui.menu", function () {
    ...
    var respond = function (elem, options, e) {
      ...
      _showMenu = function (elem, elemID, options, menu, e) {
        ...
        $(menu)
          ...
          .on(
            "mouseenter",
            ".ipsMenu_subItems",
            _.bind(_showSubMenu, this, elem, elemID, options, menu),
          );
      ...
      _showSubMenu = function (elem, elemID, options, menu, e) {
        ...
        $(e.currentTarget).on(
          "mouseleave",
          _.bind(_hideSubMenu, this, elem, elemID, options, menu),
        );
        ...
        if ($("html").attr("dir") == "rtl") {
          ...
          if (itemPosition.viewportOffset.left - subMenuSize.outerWidth - 5 < 0) {
            if (
              itemPosition.viewportOffset.right + 5 + subMenuSize.outerWidth <=
              $(window).width()
            ) {
          ...
          var top = menuItem.position()["top"] - 5;
          if (
            itemPosition.viewportOffset.left + itemSize.outerWidth + subMenuSize.outerWidth - 5 >
            $(window).width()
          ) {
      ...
      _clickIsChildOfMenu = function (clickTarget, triggerElem, menuElem) {
        if (
          _.isString($(clickTarget).get(0).className) &&
          ($(clickTarget).get(0).className.startsWith("ui-datepicker") ||
            $(clickTarget).closest("#ui-datepicker-div").length)
        ) {
          return true;
        }
      ...
      _menuClicked = function (elem, elemID, options, menu, e) {
        ...
        if (
          itemClicked.hasClass(options.className + "_itemDisabled") ||
          itemClicked.is(":disabled")
        ) {
          return;
        }
        ...
        if (itemClicked.find('[data-role="ipsMenu_selectedText"]').length) {
          $(elem)
            .find('[data-role="ipsMenu_selectedText"]')
            .html(itemClicked.find('[data-role="ipsMenu_selectedText"]').html());
        }
        if (itemClicked.find('[data-role="ipsMenu_selectedIcon"]').length) {
          $(elem)
            .find('[data-role="ipsMenu_selectedIcon"]')
            .replaceWith(itemClicked.find('[data-role="ipsMenu_selectedIcon"]').clone());
        }
        var data = {
          triggerElem: elem,
          triggerID: elemID,
      ...
      var init = function () {
        ...
        _updateBar = function (doImmediate) {
          ...
          wrapper
            ...
            .text(ips.pluralize(ips.getString("pageActionText_number"), size));
          if (!size) {
            if (doImmediate) {
              wrapper.hide();
            } else {
        ...
        _triggerAction = function (action) {
          ...
          _.each(_checkedItems, function (val, key) {
            if (
              !elem.find('input[type="checkbox"][name="' + key + '"]').length &&
              !elem.find('input[type="hidden"][name="' + key + '"]').length
            ) {
              elem.append(
                $("<input/>")
                  .attr("type", "hidden")
                  .attr("name", key)
                  .attr("data-role", "moderation")
                  .val(1),
              );
            }
          });
          ...
          if (!_.isUndefined(page)) {
            var pageNumber = $("<input/>")
              .attr("type", "hidden")
              .attr("name", "page")
              .attr("value", ips.utils.url.getPageNumber("page"));
            tools.find('[type="submit"]').before(pageNumber);
            tools
              .closest("form")
              .attr(
                "action",
                tools.closest("form").attr("action") +
                  "&page=" +
  ...
  ips.createModule("ips.ui.passwordStrength", function () {
    ...
    var respond = function (elem, options) {
        if (!$(elem).data("_passwordStrength")) {
          $(elem).data(
            "__passwordStrength",
            passwordStrengthObj(elem, _.defaults(options, defaults)),
          );
        }
      },
      destruct = function (elem) {
  ...
  var passwordStrengthObj = function (elem, options) {
    ...
    var init = function () {
      ...
      _changePassword = function () {
        ...
        _ajax(
          ips.getSetting("baseURL") + "?app=core&module=system&controller=ajax&do=passwordStrength",
          {
            dataType: "json",
            data: {
              input: value,
            ...
            if (response.result == "ok") {
              ...
              if (options.enforced) {
                ...
                if (response.score >= parseInt(options.enforcedStrength)) {
                  ...
                  if (_passwordBlurred) {
                    resultElem.show().html(
                      ips.templates.render("core.forms.validateFailText", {
      ...
      _positionAdvicePopup = function () {
        ...
        if (isRTL && position.absPos.left - adviceWidth - stemOffset > 0) {
          ...
          !isRTL &&
          position.absPos.left + fieldWidth + adviceWidth + stemOffset < windowWidth
        ) {
      ...
      var init = function () {
        ...
        _redrawLayout = function (force) {
          ...
          for (var i = 0; i < columns; i++) {
            containerList.append(
              $("<li/>")
                .addClass("ipsGrid_span" + spanClass)
                .attr("data-working", true),
            );
          }
        ...
        _distributeItems = function (currentItems) {
          ...
          _.each(currentItems, function (item, idx) {
            if (
              (itemCount - (idx + 1)) % columns.length === 0 &&
              idx >= itemCount - columns.length
            ) {
              isLastRow = true;
            }
        ...
        _checkItemWidth = function () {
          var firstItem = _getFirst();
          if (
            (options.minColSize && firstItem.outerWidth() < parseInt(options.minColSize)) ||
            (options.maxItemSize && firstItem.outerWidth() >= parseInt(options.maxItemSize))
          ) {
            _redrawLayout();
          }
        };
    ...
    var init = function () {
      ...
      run = function (data) {
        ...
        var initialHeight = Math.max(
          options.minHeight,
          Math.floor(currentWidth / options.maxItems),
        );
        ...
        while (imagesSoFar < noOfPhotos) {
          ...
          while (i < imagesInRow) {
            ...
            var thisWidth =
              !_.isNull(thisImage.filenames.small[1]) && thisImage.filenames.small[1] > 0
                ? thisImage.filenames.small[1]
                : options.minWidth;
            var thisHeight =
              !_.isNull(thisImage.filenames.small[2]) && thisImage.filenames.small[2] > 0
                ? thisImage.filenames.small[2]
                : options.minHeight;
      ...
      _buildItem = function (imageData, extra) {
        ...
        if (!_.isString(imageData.filenames.small[0])) {
          ...
          if (
            multipliedWidth <= imageData.filenames.small[1] &&
            multipliedHeight <= imageData.filenames.small[2]
          ) {
        ...
        if (!_.isUndefined(imageData.container)) {
          imageData.container = imageData.container.replace(/&apos;/gi, "'");
        }
  ...
  var productZoomObj = function (elem, options) {
    ...
    var init = function () {
      ...
      _checkAcceptableSize = function () {
        if (
          fullW - triggerBuffer <= (wrapperW ? wrapperW : wrapper.width()) ||
          fullH - triggerBuffer <= (wrapperH ? wrapperH : wrapper.height())
        ) {
          return false;
        }
        return true;
...
(function ($, _, undefined) {
  ...
  ips.createModule("ips.ui.quote", function () {
    ...
    var respond = function (elem, options) {
        ...
        var citation = ips.utils.getCitation(
          options,
          true,
          existingCitation.length ? existingCitation.text() : ips.getString("editorQuote"),
        );
        var data = {
          citation: citation,
          contenturl:
            options.contentid && options.contentcommentid
              ? ips.getSetting("baseURL") +
                "?app=core&module=system&controller=content&do=find&content_class=" +
                options.contentclass +
                "&content_id=" +
                options.contentid +
                "&content_commentid=" +
                options.contentcommentid
              : "",
        };
      ...
      _toggleQuote = function (e) {
        ...
        var target = $(e.target);
        if (
          target.is('a:not( [data-action="toggleQuote"] )') ||
          (target.closest("a").length && !target.closest("a").is('[data-action="toggleQuote"]'))
        ) {
          return;
        }
        e.preventDefault();
      ...
      var init = function () {
        ...
        _buildRatingElem = function () {
          ...
          content = ips.templates.render("core.rating.wrapper", {
            content: content,
            status: options.userRated
              ? ips.pluralize(ips.getString("youRatedThis"), [options.userRated])
              : "",
          });
          elem.append(content);
        ...
        _clickStar = function (e) {
          ...
          elem
            .find('[data-role="ratingStatus"]')
            .text(ips.pluralize(ips.getString("youRatedThis"), [value]));
          if (options.url) {
            _remoteRating(value);
            return;
          }
        ...
        _starActive = function (value, hover) {
          ratingElem
            ...
            .each(function () {
              $(this).replaceWith(
                ips.templates.render("core.rating.star", {
  ...
  ips.createModule("ips.ui.selectTree", function () {
    ...
    var selectTreeObj = function (elem, options) {
      ...
      var init = function () {
          ...
          elem.on(
            "click",
            '[data-action="nodeLoadMore"] a:not(.ipsButton_disabled)',
            _nodeLoadMore,
          );
        ...
        _zeroValChange = function (e) {
          elem.toggleClass(
            "ipsSelectTree_disabled",
            $('input[name="' + name + '-zeroVal"]').is(":checked"),
          );
        ...
        _toggleChildren = function (e, ignoreClosed) {
          ...
          if (item.hasClass("ipsSelectTree_itemOpen")) {
            ...
            if (item.attr("data-childrenLoaded")) {
              ...
              listItem.append(
                $("<div/>")
                  .attr("data-role", "childWrapper")
                  .html(
                    ips.templates.render("core.general.loading", {
              ...
              ips
                ...
                .done(function (response) {
                  ...
                  listItem.find('[data-role="childWrapper"] .ipsSelectTree_item').each(function () {
                    if (
                      $(this).attr("data-id") &&
                      selectedItems.indexOf($(this).attr("data-id")) != -1
                    ) {
        ...
        _nodeLoadMore = function (e) {
          ...
          ips
            ...
            .done(function (response) {
              ...
              results
                .find('[data-action="nodeLoadMore"] > a.ipsButton')
                .removeClass("ipsButton_disabled");
              results
                .find('[data-role="nodeList"]')
                .find(".ipsSelectTree_item")
                .each(function () {
                  if (
                    $(this).attr("data-id") &&
                    selectedItems.indexOf($(this).attr("data-id")) != -1
        ...
        _addToken = function (title, id) {
          ...
          elem.find('[data-role="tokenList"]').append(
            ips.templates.render("core.selectTree.token", {
              title: title,
              id: id,
            }),
          );
        ...
        _positionResults = function () {
          ...
          results.css({
            top: resultsPosition.top + "px",
            left: String(
              -parseFloat(results.css("borderLeftWidth")) - parseFloat(results.css("marginLeft")),
            ),
            position: "absolute",
            zIndex: ips.ui.zIndex(),
        ...
        _clickIsInElem = function (target) {
          ...
          if (
            target == rawElem ||
            target == rawResults ||
            $.contains(rawResults, target) ||
            $.contains(rawElem, target)
          ) {
            return true;
          }
          return false;
    ...
    var sideMenuObj = function (elem, options) {
      var init = function () {
        ...
        _doSelectItem = function (item, e) {
          if (
            (_.isUndefined(item.attr("data-ipsMenuValue")) &&
              !item.find('input[type="radio"], input[type="checkbox"]').length) ||
            !item.length
          ) {
            return;
          }
  ...
  ips.createModule("ips.ui.spoiler", function () {
    var respond = function (elem, options, e) {
      ...
      _toggleSpoiler = function (e) {
        ...
        if (
          target.is('a:not( [data-action="toggleSpoiler"] )') ||
          (target.closest("a").length && !target.closest("a").is('[data-action="toggleSpoiler"]'))
        ) {
          return;
        }
        e.preventDefault();
        if (header.hasClass("ipsSpoiler_closed")) {
          ...
          header
            .removeClass("ipsSpoiler_closed")
            .addClass("ipsSpoiler_open")
            .find("span")
            .text(ips.getString("spoilerClickToHide"));
          $(document).trigger("contentChange", [spoiler]);
        } else {
          header.siblings().hide();
          header
            .removeClass("ipsSpoiler_open")
            .addClass("ipsSpoiler_closed")
            .find("span")
            .text(ips.getString("spoilerClickToReveal"));
        }
        e.stopPropagation();
      };
  ...
  var stackObj = function (elem, options) {
    ...
    var init = function () {
      ...
      _addItem = function (e, after) {
        ...
        currentIndex++;
        var field = stack
          .find("[data-ipsStack-wrapper]")
          .first()
          .html()
          .replace(/(name=['"][a-zA-Z0-9\-_]+?)\[([^\]]+?)?\]/g, "$1[" + currentIndex + "]")
          .replace(/data-ipsFormData=['"](.+?)['"]/gi, "")
  ...
  ips.createModule("ips.ui.sticky", function () {
    ...
    var stickyObj = function (elem, options) {
      ...
      var _init = function () {
          if (!$(elem).is(":visible")) {
            Debug.warn(
              "Can't set up a sticky element if the element is hidden when init is called.",
            );
            return;
          }
        ...
        _scrollDocument = function () {
          ...
          if (options.stickTo == "bottom") {
            if (
              viewportHeight + bodyScroll <= originalBottom + options.spacing &&
              status == "normal"
            ) {
              _makeFixed();
            } else if (
        ...
        _makeFixed = function (offset) {
          ...
          if (
            options.width &&
            (options.width.indexOf("#") === 0 || options.width.indexOf(".") === 0)
          ) {
...
(function ($, _, undefined) {
  ...
  var tabBarObj = function (elem, options) {
    var rawElem = elem.get(0),
      barId = rawElem.id,
      tabs = $(elem).find(options.itemSelector),
      active,
      ajaxObj,
      loadPanel;
    var init = function () {
      ...
      _updateURL = function (tabId) {
        ...
        var href = $("#" + tabId).attr("href"),
          title =
            options.updateTitle && $("#" + tabId).attr("title")
              ? $("#" + tabId).attr("title")
              : document.title;
  ...
  var uploadObj = function (elem, options, e) {
    ...
    var init = function () {
        ...
        if (_supportsDraggable()) {
          $(elem)
            .find(".ipsAttachment_supportDrag")
            .show()
            .end()
          ...
          $(elem)
            ...
            .on("click", function (e) {
              ...
              var dialogRef = ips.ui.dialog.create({
                ...
                url:
                  ips.getSetting("baseURL") +
                  "?app=core&module=system&controller=pixabay&uploader=" +
                  $(elem).attr("data-ipsUploader-name"),
              });
              dialogRef.show();
            });
        }
      ...
      _buildExistingFiles = function (files) {
        ...
        for (var i = 0; i < files.length; i++) {
          var data = {
            ...
            thumbnail_for_css: files[i].thumbnail
              ? files[i].thumbnail.replace("(", "\\(").replace(")", "\\)")
              : "",
          ...
          if (files[i]["hasThumb"]) {
            data["thumb"] =
              "<img src='" +
              (files[i]["thumbnail"] ? files[i]["thumbnail"] : files[i]["imagesrc"]) +
              "' class='ipsImage'>";
          }
      ...
      _getUploaderSettings = function () {
        ...
        if (options.dropTarget) {
          ...
          pluploadOptions.drop_element = $(elem)
            .find(".ipsAttachment_dropZone")
            .identify()
            .attr("id");
        }
      ...
      _buildThumb = function (fileElem, file, info) {
        ...
        if (info.imagesrc) {
          ...
          fileElem
            ...
            .css(
              "background-image",
              'url( "' + (info.thumbnail ? info.thumbnail : info.imagesrc) + '")',
            );
        } else if (info.videosrc) {
          toInsert = $("<video/>").append(
            $("<source/>").attr({
              src: info.videosrc,
      ...
      _deleteFile = function (fileElem, e) {
        ...
        ips.getAjax()(
          baseUrl +
            ...
            options.postkey +
            "&deleteFile=" +
            encodeURIComponent(fileElem.attr("data-fileid")),
        );
        uploadCount--;
      ...
      events = {
          ...
          if (_supportsDraggable()) {
            ...
            var _drag = (function () {
              ...
              $(document).on("dragenter", function (e) {
                if (
                  currentElem &&
                  !$(e.target).is(dropElement) &&
                  !$.contains(dropElement.get(0), currentElem)
                ) {
        ...
        filesAdded: function (up, files) {
          if (!options.multiple) {
            ...
            ips.ui.alert.show({
              ...
              message: ips.getString("uploadTotalErr", {
                ...
                size_suffix:
                  options.maxTotalSize >= 1 ? ips.getString("size_mb") : ips.getString("size_kb"),
              }),
              callbacks: {},
            });
            _.each(files, function (file, idx) {
          ...
          var allowedFileTypes =
            options.allowedFileTypes !== null
              ? $.parseJSON(options.allowedFileTypes).join(",").toLowerCase().split(",")
              : "";
          var sizeAllowance = options.maxTotalSize
            ? options.maxTotalSize * 1048576 - totalSize
            : null;
          _.each(files, function (file, idx) {
            ...
            if (
              allowedFileTypes &&
              allowedFileTypes.indexOf(
                file.name.substr((~-file.name.lastIndexOf(".") >>> 0) + 2).toLowerCase(),
              ) === -1
            ) {
              badType++;
              up.removeFile(file);
          ...
          if (tooLarge) {
            var errorString = ips.getString("uploadSizeErr", {
              ...
              size_suffix:
                options.maxFileSize > 1 ? ips.getString("size_mb") : ips.getString("size_kb"),
            });
            ips.ui.alert.show({
              type: "alert",
              icon: "warn",
        ...
        uploadComplete: function (up, files) {
          ...
          if (
            _.isUndefined(ips.utils.events.getVisibilityProp()) ||
            !document[ips.utils.events.getVisibilityProp()]
          ) {
            return;
          }
          var text = [];
        ...
        fileUploaded: function (up, file, info) {
          ...
          try {
            ...
            elem.before(
              $('<input type="hidden">')
                .attr("name", elem.attr("data-ipsUploader-name") + "_existing[" + file.id + "]")
                .attr("value", jsonInfo.id),
            );
            if (jsonInfo["error"]) {
              fileElem.on(
                "click",
                '[data-role="deleteFile"]',
                _.bind(_deleteFile, fileElem, fileElem),
              );
        ...
        error: function (up, err) {
          ...
          var errorMessage = ips.getString("pluploaderr_" + err.code, {
            ...
            allowed_extensions:
              options.allowedFileTypes !== null
                ? $.parseJSON(options.allowedFileTypes).join(",")
                : "",
      ...
      var init = function () {
          if (options.live) {
            $(elem).on(
              ...
              'input:not( [type="button"] ):not( [type="checkbox"] ):not( [type="hidden"] )' +
                ':not( [type="radio"] ):not( [data-validate-bypass] ), textarea:not( [data-validate-bypass] )',
              _textEvent,
            );
        ...
        _textEvent = function (e) {
          ...
          if (e.type == "blur" || e.type == "focusout") {
            if (
              field.val().length >= options.characterLimit ||
              field.is('[type="number"], [type="range"]')
            ) {
              _validate(field);
            }
          } else {
        ...
        _displayErrors = function (target, results) {
          ...
          for (var i = 0; i < results.messages.length; i++) {
            errorList.append(
              ips.templates.render("core.forms.validationItem", {
  ...
  ips.createModule("ips.ui.wizard", function () {
    ...
    var refresh = function (elem, e) {
        ...
        if (target.is("form")) {
          ...
          e.preventDefault();
          ips
            .getAjax()(target.attr("action"), {
              data:
                target.serialize() +
                "&_wizardHeight=" +
                elem.find('[data-role="loading"]').outerHeight(),
              type: "post",
            })
            .done(function (response) {
  ...
  ips.createModule("ips.utils.validate", function (options) {
    ...
    var validate = function (field, conditions, ignoreHTML5) {
      ...
      _getMessage = function (type, args) {
        return ips.pluralize(
          ips.getString("validation_" + type, {
            data: args,
          }),
      ...
      trackPageView = function (url) {
        try {
          if (ips.getSetting("analyticsProvider") == "ga") {
            ...
            ips.getSetting("analyticsProvider") == "custom" &&
            _.isFunction(ips.getSetting("paginateCode"))
          ) {
  ...
  ips.createModule("ips.utils.color", function () {
    ...
    var convertHex = function (hex, toHue, toSat) {
      ...
      hexToRGB = function (hex) {
        ...
        return [
          hexToRGB(hex.slice(0, 2)) / 255,
          hexToRGB(hex.slice(2, 4)) / 255,
          hexToRGB(hex.slice(4, 6)) / 255,
        ];
      },
  ...
  ips.createModule("ips.utils.cookie", function () {
    ...
    var init = function () {
      ...
      set = function (cookieKey, value, sticky) {
        ...
        if (
          !_.isUndefined(ips.getSetting("cookie_domain")) &&
        ...
        if (
          !_.isUndefined(ips.getSetting("cookie_prefix")) &&
          ips.getSetting("cookie_prefix") != ""
        ) {
  ...
  ips.createModule("ips.utils.css", function () {
    ...
    var init = function () {},
      ...
      supportsTransform = function () {
        ...
        if (
          !_.isUndefined(bs.transform) ||
          !_.isUndefined(bs.WebkitTransform) ||
          !_.isUndefined(bs.MozTransform) ||
          !_.isUndefined(bs.OTransform)
        ) {
          return true;
        }
        return false;
      ...
      generateGradient = function (angle, stops, asPureCSS) {
        ...
        for (var i = 0; i < prefixes.length; i++) {
          output.push(
            _buildPrefix(prefixes[i], "linear-gradient") +
              "(" +
              angles[prefixes[i]] +
              ", " +
              stops +
    ...
    var init = function (queryString) {
      ...
      set = function (type, key, value, isPrivate) {
        if (enabled) {
          ...
          if (
            isPrivate &&
            (!_.isUndefined(ips.getSetting("isAcp")) ||
              (_.isUndefined(ips.utils.cookie.get("login_key")) &&
                _.isUndefined(
                  ips.getSetting("cookie_prefix") + ips.utils.cookie.get("login_key"),
                ))) &&
      ...
      inline: function (command, html) {
        return {
          exec: function (editor) {
            ...
            element.setHtml(
              html
                .replace(/\{contents\}/g, '<span data-content-marker="true"></span>')
                .replace(/\{content\}/g, '<span data-content-marker="true"></span>'),
            );
        ...
        return {
          exec: function (editor) {
            ...
            if (paragraphs.length < 1) {
              var para = editor.document.createElement(
  ...
  ips.createModule("ips.utils.emoji", function () {
    var _emoji = null,
      ...
      getEmoji = function (callback) {
        ...
        var storage = ips.utils.db.get(
          "emoji",
          ips.getSetting("baseURL") + "-" + ips.getSetting("emoji_cache"),
        );
        var categories = ips.utils.db.get(
          "emojiCategories",
          ips.getSetting("baseURL") + "-" + ips.getSetting("emoji_cache"),
        );
        if (storage && categories) {
          ...
          this._ajax = ips
            .getAjax()(
              ips.getSetting("baseURL") +
                "index.php?app=core&module=system&controller=editor&do=emoji",
            )
            .done(
              function (emoji) {
                this._emoji = {};
                  ...
                  for (var i = 0; i < emoji[category].emoji.length; i++) {
                    if (this.canRender(emoji[category].emoji[i].code)) {
                      if (emoji[category].emoji[i].skinTone) {
                        if (canUseTones === null) {
                          if (
                            !this.canRender(this.tonedCode(emoji[category].emoji[i].code, "light"))
                          ) {
                            canUseTones = false;
                          } else {
                            canUseTones = true;
                      ...
                      emoji[category].emoji[i].shortNames.push(
                        ips.getString("emoji-" + emoji[category].emoji[i].name),
                      );
      ...
      canRender = function (code) {
        ...
        if (this._testingCanvasContext == null) {
          ...
          if (
            ...
            if (typeof this._testingCanvasContext.fillText == "function") {
              ...
              this._testingCanvasContext.font =
                '5px "Apple Color Emoji", "Segoe UI Emoji", "NotoColorEmoji", "Segoe UI Symbol", "Android Emoji", "EmojiSymbols"';
              this._testingCanvasContext.fillText(
                String.fromCodePoint(parseInt("1F91F", 16)),
                0,
                0,
              );
              this._invalidCharacterImageData.push(
                Array.prototype.toString.call(
                  this._testingCanvasContext.getImageData(0, 0, 6, 6).data,
                ),
              );
        ...
        if (
          this._invalidCharacterImageData.indexOf(
            Array.prototype.toString.call(this._testingCanvasContext.getImageData(0, 0, 6, 6).data),
          ) != -1
        ) {
          return false;
        }
        if (
          Array.prototype.toString.call(this._testingCanvasContext.getImageData(7, 0, 1, 6).data) !=
        ...
        if (codeToUse.substr(0, 7) == "custom-") {
          ...
          for (var i = 0; i < this._emoji[parts[1]].length; i++) {
            if (this._emoji[parts[1]][i].code == codeToUse) {
              ...
              if (lazyLoad) {
                imgTag +=
                  'src="' +
                  ips.getSetting("blankImg") +
                  '" data-loading data-src="' +
                  this._emoji[parts[1]][i].image +
                  '"';
              } else {
              ...
              if (
                parseInt(this._emoji[parts[1]][i].width) &&
                parseInt(this._emoji[parts[1]][i].height)
              ) {
                imgTag +=
                  ' width="' +
                  this._emoji[parts[1]][i].width +
                  '" height="' +
                  this._emoji[parts[1]][i].height +
                  '"';
              }
          ...
          if (lazyLoad) {
            return (
              ...
              '" alt="' +
              character +
              '" class="ipsEmoji" data-emoticon="true">'
            );
          } else {
            return (
              '<img src="' +
      ...
      editorElement = function (code) {
        if (ips.getSetting("emoji_style") == "native" && code.substr(0, 7) != "custom-") {
          return CKEDITOR.dom.element.createFromHtml(
            "<span class='ipsEmoji'>" + this.emojiFromHex(code) + "</span>",
          );
        } else {
  ...
  ips.createModule("ips.utils.form", function () {
    var serializeAsObject = function (jQueryObj, customSerializers) {
      ...
      _.each(asArray, function (val) {
        ...
        if (
          customSerializers &&
          !_.isUndefined(customSerializers[val.name]) &&
          _.isFunction(customSerializers[val.name])
        ) {
...
(function ($, _, undefined) {
  ...
  ips.createModule("ips.utils.lazyLoad", function () {
    ...
    var contentSelector =
      "img[data-src], [data-background-src], iframe[data-embed-src], video[data-video-embed]";
    var init = function () {
      ...
      observe = function (node, callbacks, config) {
        ...
        if (
          !_.isUndefined(callbacks.loadCallback) ||
          !_.isUndefined(callbacks.loadedCallback) ||
          !_.isUndefined(callbacks.imgLoadedCallback)
        ) {
      ...
      preload = function (rawNode) {
        if (
          _isImg(rawNode) &&
          !rawNode.hasAttribute("data-loaded") &&
          !rawNode.hasAttribute("data-loading")
        ) {
          var lazyLoaded = [rawNode];
        } else {
          var lazyLoaded = rawNode.querySelectorAll(
        ...
        _.each(lazyLoaded, function (element) {
          ...
          if (
            (element.hasAttribute("style") && element.style.width) ||
            ...
            if (element.style.height !== "auto") {
              ...
              element.style.height =
                parseInt((parseInt(width) / 100) * element.getAttribute("data-ratio")) + "px";
            }
          } else {
      ...
      _intersection = function (entries) {
        for (var i = 0; i < entries.length; i++) {
          if (entries[i].isIntersecting || entries[i].intersectionRatio > 0) {
            ...
            if (
              entries[i].target.id &&
              !_.isUndefined(_registry[entries[i].target.id]) &&
              _.isFunction(_registry[entries[i].target.id].loadCallback)
            ) {
      ...
      _load = function (rawNode, imgLoadedCallback) {
        ...
        _.each(itemsToLoad, function (element) {
          if (_isImg(element)) {
            if (
              (rawNode.id &&
                !_.isUndefined(_registry[rawNode.id]) &&
                _.isFunction(_registry[rawNode.id].imgLoadedCallback)) ||
              _.isFunction(imgLoadedCallback)
            ) {
              replaceImg(
                element,
                imgLoadedCallback ? imgLoadedCallback : _registry[rawNode.id].imgLoadedCallback,
              );
            } else {
              replaceImg(element);
            }
        ...
        if (
          rawNode.id &&
          !_.isUndefined(_registry[rawNode.id]) &&
          _.isFunction(_registry[rawNode.id].loadedCallback)
        ) {
      ...
      replaceImg = function (element, imgLoadedCallback) {
        ...
        element.addEventListener("load", function () {
          if (
            ...
            element.style.height =
              parseInt((parseInt(element.style.width) / 100) * element.getAttribute("data-ratio")) +
              "px";
          } else {
            element.style.height = "auto";
          }
      ...
      applyLazyLoadAttributes = function (rawNode, dims, forceUpdate) {
        if (
          rawNode.tagName.toLowerCase() !== "img" ||
          ((rawNode.hasAttribute("data-loaded") || rawNode.hasAttribute("data-emoticon")) &&
            !forceUpdate)
        ) {
          return;
        }
  ...
  ips.createModule("ips.utils.notification", function () {
    ...
    var _isSupported = function () {
      ...
      hasPermission = function () {
        if (
          !supported ||
          ips.utils.cookie.get("noBrowserNotifications") ||
    ...
    function notification(options) {
      ...
      this._options.body = _.unescape(
        this._options.body.replace(/&#039;/g, "'").replace(/<[^>]*>?/g, ""),
      );
    ...
    var getElemPosition = function (elem) {
      ...
      positionElem = function (options) {
        ...
        switch (bestFit.horizontal) {
          case "center":
            toReturn.left =
              offsetParent.left + triggerDims.outerWidth / 2 - targetDims.outerWidth / 2;
            break;
          case "left":
          ...
          case "right":
            toReturn.left =
              offsetParent.left -
              targetDims.outerWidth +
              triggerDims.outerWidth / 2 +
              stemOffset.left;
            break;
        }
      ...
      _getBestFit = function (
        ...
        if (position.horizontal == "center") {
          var targetLeft =
            viewportOffset.left + triggerDims.outerWidth / 2 - targetDims.outerWidth / 2;
        ...
        if (position.horizontal == "left") {
          if (
            viewportOffset.left + triggerDims.outerWidth / 2 + targetDims.outerWidth - offset.left >
            theWindow.width()
          ) {
        ...
        if (attemptToFit) {
          if (position.vertical == "top" || preferBottom) {
            ...
            if (
              viewportOffset.top + triggerDims.outerHeight + targetDims.outerHeight + offset.top >
              theWindow.height()
            ) {
  ...
  ips.createModule("ips.utils.responsive", function (options) {
    ...
    var currentIs = function (toCheck) {
      ...
      executeCallbacks = function (enterPoint, exitPoint) {
        if (
          !_.isUndefined(enterPoint) &&
          !_.isUndefined(callbacks[enterPoint]) &&
          !_.isUndefined(callbacks[enterPoint]["enter"]) &&
          callbacks[enterPoint]["enter"].length
        ) {
        ...
        if (
          !_.isUndefined(exitPoint) &&
          !_.isUndefined(callbacks[exitPoint]) &&
          !_.isUndefined(callbacks[exitPoint]["exit"]) &&
          callbacks[exitPoint]["exit"].length
        ) {
        ...
        if (!ips.utils.time.supportsHTMLDate()) {
          try {
            ...
            if (input.hasClass("hasDatepicker")) {
              ...
              Debug.log(
                "no datepicker yet: " + thisDate.toString() + "(" + thisDate.getTime() + ")",
              );
            }
            return thisDate;
          } catch (err) {
      ...
      formatTime = function (dateObj, localeFormat) {
        ...
        var formatters = {
          ...
          R: function (d) {
            ...
            var mins = d.getMinutes().toString();
            return (
              (hrs.length === 1 ? "0" : "") + hrs + ":" + (mins.length === 1 ? "0" : "") + mins
            );
          },
          S: function (d) {
            var seconds = d.getSeconds().toString();
          ...
          c: function (d) {
            ...
            var seconds = d.getSeconds().toString();
            return (
              ips.getString("day_" + d.getMonth() + "_short") +
              " " +
              ips.getString("month_" + d.getMonth() + "_short") +
              " " +
              d.getDate().toString() +
              " " +
              (hrs.length === 1 ? "0" : "") +
          ...
          D: function (d) {
            ...
            return (
              ...
              day +
              "/" +
              parseInt(d.getFullYear().toString().substr(0, 2)).toString()
            );
          },
          F: function (d) {
            var month = d.getMonth().toString();
        ...
        return localeFormat.format.replace(
          /%([aAdejuwUVWbBhmCgGyYHkIlMNPprRSTXzZcDFsxnt%]|OB)/g,
...
(function ($, _, undefined) {
  ...
  ips.controller.register("core.global.stockart.pixabay", {
    ...
    _status: "init",
    setup: function () {
      this.uploader = $(document).find(
        '[data-ipsUploader-name="' + this.scope.attr("data-uploader") + '"]',
      );
      this._doSearch(null);
    },
    ...
    _doSearch: function (value) {
      ...
      ips
        .getAjax()(
          ips.getSetting("baseURL") +
            "?app=core&module=system&controller=pixabay&do=search&offset=" +
            offset +
            "&limit=" +
            this._perPage,
          {
    ...
    selectImage: function (e) {
      ...
      ips
        .getAjax()(
          ips.getSetting("baseURL") +
            "?app=core&module=system&controller=pixabay&do=getById&id=" +
            image.attr("data-id"),
        )
        .done(function (response) {
  ...
  ips.controller.register("core.global.editor.code", {
      ...
      ips.loader
        ...
        .then(function () {
          ...
          for (var i in self.languageMap) {
            if (
              self.languageMap[i] ==
              self.scope.find('[data-role="codeModeSelect"]').attr("data-codeLanguage")
            ) {
              selectedMode = i;
              break;
            }
          ...
          self.instance = CodeMirror.fromTextArea(
            document.getElementById("elCodeInput" + self.scope.attr("data-randomstring")),
            {
              autofocus: true,
              mode: selectedMode,
              lineWrapping: true,
    ...
    changeMode: function (e) {
      this.instance.setOption(
        "mode",
        this.scope.find('[data-role="codeModeSelect"] option:selected').attr("name"),
      );
    },
    ...
    insertCode: function (e) {
      ...
      if (this.scope.find('[data-role="codeModeSelect"] option:selected').attr("name") == "null") {
        ...
        var element = CKEDITOR.dom.element.createFromHtml(
          "<pre class='ipsCode prettyprint " + lang + "'></pre>",
        );
      }
...
(function ($, _, undefined) {
  ...
  ips.controller.register("core.global.editor.codePreview", {
    ...
    fetchPreview: function (data) {
      ...
      $("#" + scope.attr("data-name") + "_preview")
        .addClass("ipsLoading")
        .html("");
      ips
        .getAjax()(scope.attr("data-preview-url"), {
          type: "POST",
          data: {
  ...
  ips.controller.register("core.global.editor.customtags", {
    ...
    reloadTags: function () {
      if (this.scope.attr("data-tagSource")) {
        ips
          .getAjax()(this.scope.attr("data-tagSource"))
          .done(function (response, status, jqXHR) {
...
(function ($, _, undefined) {
  ...
  ips.controller.register("core.global.editor.emoticons", {
    ...
    setup: function () {
      ...
      ips.utils.emoji.getEmoji(
        function (emoji, categories) {
          setTimeout(
            function () {
    ...
    _buildEmoji: function (emoji, tone, search, categories) {
      ...
      for (var i in categories) {
        ...
        for (var i = 0; i < emoji[category].length; i++) {
          ...
          emojiForThisRow += ips.templates.render("core.editor.emoji", {
            ...
            name: ips.haveString("emoji-" + emoji[category][i].name)
              ? ips.getString("emoji-" + emoji[category][i].name)
              : emoji[category][i].name,
            code: codeToUse,
          });
          pos++;
          categoryCount++;
          ...
          if (categoryHtml) {
            var categoryTitle =
              [
                ...
                ? emoji[category][0].categoryName
                : ips.getString("emoji-category-" + category);
            finalHtml += ips.templates.render("core.editor.emoticonCategory", {
              title: categoryTitle,
              categoryID: category,
              emoticons: categoryHtml,
            ...
            emojiForThisRow = "";
            menuContent.push(
              ips.templates.render("core.editor.emoticonMenu", {
                title: categoryTitle,
                count: categoryCount,
                categoryID: category,
              }),
      ...
      var replaceEmojiInCategory = function (category) {
        var emoji = category.querySelectorAll("img[data-src]");
        _.each(emoji, function (img) {
          img.setAttribute("src", img.getAttribute("data-src"));
          img.addEventListener("load", emojiLoaded);
        });
      };
      var emojiLoaded = function (e) {
        e.target.removeAttribute("data-loading");
      };
      this.scope.find(".ipsMenu_innerContent .ipsEmoticons_category").each(function () {
        ips.utils.lazyLoad.observe(
          this,
          {
            preloadCallback: $.noop,
            imgLoadedCallback: $.noop,
            loadedCallback: $.noop,
            loadCallback: function (category) {
              replaceEmojiInCategory(category);
              var nextCategory = $(this).next(".ipsEmoticons_category");
              if (nextCategory.length) {
                replaceEmojiInCategory(nextCategory.get(0));
              }
            },
          },
          {
      ...
      if (
        ips.getSetting("emoji_style") != "disabled" &&
        (ips.getSetting("emoji_style") != "native" || ips.utils.emoji.canRender("1F44D-1F3FB"))
      ) {
        this.scope.find("[data-role='skinToneMenu']").show();
        switch (tone) {
          case "light":
            this.scope
              .find("[data-role='skinToneIndicator']")
              .text(
                String.fromCodePoint(parseInt("1F44D", 16)) +
                  String.fromCodePoint(parseInt("1F3FB", 16)),
              );
            break;
          case "medium-light":
            this.scope
              ...
              .text(
                String.fromCodePoint(parseInt("1F44D", 16)) +
                  String.fromCodePoint(parseInt("1F3FC", 16)),
              );
            break;
          case "medium":
            this.scope
              ...
              .text(
                String.fromCodePoint(parseInt("1F44D", 16)) +
                  String.fromCodePoint(parseInt("1F3FD", 16)),
              );
            break;
          case "medium-dark":
            this.scope
              ...
              .text(
                String.fromCodePoint(parseInt("1F44D", 16)) +
                  String.fromCodePoint(parseInt("1F3FE", 16)),
              );
            break;
          case "dark":
            this.scope
              ...
              .text(
                String.fromCodePoint(parseInt("1F44D", 16)) +
                  String.fromCodePoint(parseInt("1F3FF", 16)),
              );
            break;
          default:
            this.scope
              .find("[data-role='skinToneIndicator']")
              .text(String.fromCodePoint(parseInt("1F44D", 16)));
            break;
        }
      }
    },
    ...
    _doSearch: function (value) {
      ips.utils.emoji.getEmoji(
        function (emoji, categories) {
          this._buildEmoji(
            emoji,
            ips.utils.cookie.get("emojiSkinTone"),
    ...
    changeCategory: function (e, data) {
      this.scope
        ...
        .scrollTop(
          this.scope.find(".ipsMenu_innerContent").scrollTop() +
            this.scope.find('[data-categoryid="' + data.selectedItemID + '"]').position().top -
            85,
        );
    },
  });
...
(function ($, _, undefined) {
  ...
  ips.controller.register("core.global.editor.giphy", {
    ...
    _doSearch: function (value) {
      ...
      ips
        .getAjax()(
          this._editor.config.controller + "&do=giphy&offset=" + offset + "&limit=" + this._perPage,
          {
            type: "POST",
            data: {
              search: value,
...
(function ($, _, undefined) {
  ...
  ips.controller.register("core.global.editor.image", {
    ...
    toggleAlign: function (e) {
      ...
      this.scope
        .find('label[for^="image_align"]')
        .removeClass("ipsButton_primary")
        .addClass("ipsButton_light");
    ...
    _updateImage: function (e) {
      ...
      if (parseInt(widthInput.val()) > parseInt(widthInput.attr("max"))) {
        ...
        this.scope.find('[data-role="imageSizeWarning"]').text(
          ips.getString("editorImageMaxWidth", {
      ...
      if (parseInt(heightInput.val()) > parseInt(heightInput.attr("max"))) {
        ...
        widthInput.closest(".ipsFieldRow").addClass("ipsFieldRow_error");
        this.scope.find('[data-role="imageSizeWarning"]').text(
          ips.getString("editorImageMaxHeight", {
            maxheight: heightInput.attr("max"),
          }),
        );
      }
      if (!error) {
        var editor = $(".cke." + this.scope.attr("data-editorUniqueId"))
          .closest("[data-ipsEditor]")
          .data("_editor");
        editor.updateImage(
          widthInput.val(),
          sameRatio ? "auto" : heightInput.val(),
          this.scope.find('[data-role="imageAlign"]:checked').val(),
          this.scope.find('[data-role="imageLink"]').val(),
          this.scope.find('[data-role="imageAlt"]').val(),
        );
        this.trigger("closeDialog");
      }
    },
...
(function ($, _, undefined) {
  ...
  ips.controller.register("core.global.editor.insertable", {
    ...
    insertSelected: function (e) {
      ...
      var editor = $('textarea[name="' + this._editorID + '"]')
        .closest("[data-ipsEditor]")
        .data("_editor");
    ...
    _showImageTooltip: function (fileID) {
      ...
      var imageFile = $("#cke_" + this._editorID)
        .find('[data-fileID="' + fileID + '"]')
        .last();
      var self = this;
      var positionInfo = {
        trigger: imageFile,
    ...
    _checkSelectedButton: function () {
      ...
      this.scope
        .find('[data-action="clearAll"]')
        .toggleClass("ipsButton_disabled", !(_.size(this._selectedItems) > 0));
    ...
    _buildInsertData: function (element) {
      ...
      var mimeType = "";
      if (type == "image") {
        url = element.attr("data-thumbnailurl")
          ? element.attr("data-thumbnailurl")
          : element.attr("data-fullsizeurl");
    ...
    _buildInsert: function (item) {
      ...
      if (item.type == "image") {
        ...
        if (item.fullImage) {
          var link = $("<a>")
            .attr("href", item.fullImage)
            .addClass("ipsAttachLink ipsAttachLink_image");
        ...
        element = $("<a>")
          .addClass("ipsAttachLink")
          .html(item.title)
          .attr("data-fileid", item.fileID)
          .attr("data-fileext", item.extension)
      ...
      if (selectedElement && selectedElement.is("img")) {
        ...
        if ($(this.scope).data("image")) {
              ...
              .done(function (response) {
                if (response.embed) {
                  ...
                  if (!_.isUndefined(response.errorMessage)) {
                    scope
                      .find(".ipsFieldRow.ipsFieldRow_fullWidth")
                      .append(
                        "<span class='elLinkError ipsType_warning'>" +
          ...
          element.setAttribute(
            "href",
            url.replace(/'/g, "%27").replace(/"/g, "%22").replace(/</g, "%3C").replace(/>/g, "%3E"),
          );
          editor.insertElement(element);
          this.scope.find("input.cEditorURL").val("");
          this.trigger("closeDialog");
...
(function ($, _, undefined) {
  ...
  ips.controller.register("core.global.editor.mymediasection", {
    ...
    paginationClicked: function (e, data) {
      ...
      if (url == "#") {
        url =
          data.paginationElem.find('[data-role="pageJump"]').attr("action") +
          "&page=" +
          data.pageNo;
      }
      this._ajax = ips
...
(function ($, _, undefined) {
  ...
  ips.controller.register("core.global.editor.preview", {
    ...
    setup: function () {
      this.scope
        .find('[data-role="previewContainer"]')
        .html(ips.templates.get("core.editor.previewLoading"));
