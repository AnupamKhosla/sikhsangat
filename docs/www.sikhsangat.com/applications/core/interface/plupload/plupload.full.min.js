      ...
      function () {
        (function (a, w) {
                      ...
                      if (!!a) {
                        for (r = 0; r < c.length; r++) {
                          ...
                          if (typeof o === h && o.length > 0) {
                            if (o.length == 2)
                              if (typeof o[1] == d) e[o[0]] = o[1].call(this, s);
                              else e[o[0]] = o[1];
                            else if (o.length == 3)
                              if (typeof o[1] === d && !(o[1].exec && o[1].test))
                                e[o[0]] = s ? o[1].call(this, s, o[2]) : f;
                              else e[o[0]] = s ? s.replace(o[1], o[2]) : f;
                            else if (o.length == 4)
                              e[o[0]] = s ? o[3].call(this, s.replace(o[1], o[2])) : f;
                          } else e[o] = s ? s : f;
                        }
                        break;
                      }
                  ...
                  for (var i in t)
                    if (typeof t[i] === h && t[i].length > 0) {
                      for (var n = 0; n < t[i].length; n++)
                        if (g.has(t[i][n], e)) return i === r ? f : i;
              ...
              var n = {
                ...
                use_blob_uri: function () {
                  ...
                  n.use_blob_uri =
                    ...
                    (o.browser !== "IE" || o.verComp(o.version, "11.0.46", ">="));
          ...
          e("moxie/core/utils/Dom", ["moxie/core/utils/Env"], function (l) {
            ...
            var t = function (e, t) {
              if (!i(e, t))
                e.className = !e.className ? t : e.className.replace(/\s+$/, "") + " " + t;
            };
            var n = function (e, t) {
              if (e.className) {
                var i = new RegExp("(^|\\s+)" + t + "(\\s+|$)");
            ...
            var o = function (e, t) {
              ...
              if (
                ...
                l.browser === "IE" &&
                (!o.documentMode || o.documentMode < 8)
              ) {
                a = u(e);
                s = u(t);
                return {
              ...
              f.extend(e.prototype, {
                ...
                dispatchEvent: function (t) {
                  ...
                  if (e) {
                    ...
                    o.type = t;
                    n.unshift(o);
                    if (MXI_DEBUG && l.debug.events)
                      l.log(
                        "%cEvent '%s' fired on %s",
                        "color: #999;",
                        o.type,
                        (this.ctorName ? this.ctorName + "::" : "") + i,
                      );
                    var u = [];
                    f.each(e, function (t) {
                      n[0].target = t.scope;
                  ...
                  return {
                    ...
                    removeAllInstances: function () {
                      ...
                      c.each(r, function (e, t) {
                        if (c.typeOf(e.instance.destroy) === "function")
                  ...
                  c.each(e, function (e, t) {
                    if (n.hasOwnProperty(t)) {
                      ...
                      if (!r) r = i;
                        ...
                        if (MXI_DEBUG && l.debug.runtime)
                          l.log("\t\t%s: %s (conflicting mode requested: %s)", t, e, i);
                        return (r = false);
                      }
                    }
                    if (MXI_DEBUG && l.debug.runtime)
                      l.log("\t\t%s: %s (compatible modes: %s)", t, e, r);
                  });
                    ...
                    function o(e) {
                      ...
                      if (!i) {
                        if (MXI_DEBUG && s.debug.runtime)
                          s.log("Constructor for '%s' runtime is not available.", t);
                        o(e);
                        return;
                      }
                      if (MXI_DEBUG && s.debug.runtime) {
                      ...
                      a.bind("Exception", function (e, t) {
                        var i =
                          t.name + "(#" + t.code + ")" + (t.message ? ", from: " + t.message : "");
                        if (MXI_DEBUG && s.debug.runtime)
                          s.log("Runtime '%s' has thrown an exception: %s", this.type, i);
                        r.trigger(
                          "RuntimeError",
                          new u.RuntimeError(u.RuntimeError.EXCEPTION_ERR, i),
                        );
                      });
          ...
          e(
            ...
            function (s, n, r, u, o, e, l, c, f) {
              ...
              function t(a) {
                ...
                var e, t, i;
                if (s.inArray(s.typeOf(a), ["string", "node"]) !== -1)
                  a = {
                    browse_button: a,
                  };
                ...
                a = s.extend({}, i, a);
                if (typeof a.required_caps === "string")
                  a.required_caps = c.parseCaps(a.required_caps);
                ...
                s.extend(this, {
                  ...
                  disable: function (e) {
                    ...
                    if (t)
                      this.exec("FileInput", "disable", s.typeOf(e) === "undefined" ? true : e);
                  },
                  refresh: function () {
          ...
          e(
            ...
            function (t, r, e, o, a, i, s, n, u) {
              ...
              function c(i) {
                ...
                if (r.getStyle(i.container, "position") === "static")
              ...
              return function () {
                ...
                function t(e, t) {
                  if (t.isDetached()) {
                    ...
                    var a = this.connectRuntime(t.ruid).exec.call(
                      this,
                      "FileReaderSync",
                      "read",
                      e,
              ...
              function t() {
                ...
                a.extend(this, {
                  append: function (i, e) {
                    ...
                    else if ("null" === t || "undefined" === t || ("number" === t && isNaN(e)))
                      n.append(i, "false");
                    else
                      o.push({
                        name: i,
          ...
          e(
            ...
            function (T, S, e, O, D, N, C, L, t, M, F, B) {
              var P = {
                100: "Continue",
              ...
              function U() {
                ...
                T.extend(this, n, {
                  ...
                  open: function (e, t, i, n, r) {
                    ...
                    if (/[\u0100-\uffff]/.test(e) || O.utf8_encode(e) !== e)
                      throw new S.DOMException(S.DOMException.SYNTAX_ERR);
                    if (
                      ...
                      u = e.toUpperCase();
                    if (!!~T.inArray(u, ["CONNECT", "TRACE", "TRACK"]))
                      throw new S.DOMException(S.DOMException.SECURITY_ERR);
                    t = O.utf8_encode(t);
                    o = D.parseUrl(t);
                    x = D.hasSameOrigin(o);
                    s = D.resolveUrl(t);
                    ...
                    if (
                      ...
                      throw new S.DOMException(S.DOMException.INVALID_ACCESS_ERR);
                    m = !a;
                    h = false;
                    l = {};
                    A.call(this);
                  ...
                  setRequestHeader: function (e, t) {
                    ...
                    if (R("readyState") !== U.OPENED || h)
                      throw new S.DOMException(S.DOMException.INVALID_STATE_ERR);
                    if (/[\u0100-\uffff]/.test(e) || O.utf8_encode(e) !== e)
                      throw new S.DOMException(S.DOMException.SYNTAX_ERR);
                  ...
                  overrideMimeType: function (e) {
                    var t, i;
                    if (!!~T.inArray(R("readyState"), [U.LOADING, U.DONE]))
                      throw new S.DOMException(S.DOMException.INVALID_STATE_ERR);
                    e = T.trim(e.toLowerCase());
                  ...
                  send: function (e, t) {
                    ...
                    if (!this.withCredentials)
                      this.withCredentials =
                        y.required_caps && y.required_caps.send_browser_cookies && !x;
                ...
                this.upload.handleEventProps(H);
                ...
                function I(e) {
                  ...
                  function r(t) {
                    ...
                    E.bind("Load", function (e) {
                      ...
                      R(
                        "response",
                        t.exec.call(E, "XMLHttpRequest", "getResponse", R("responseType")),
                      );
                      if (!!~T.inArray(R("responseType"), ["text", ""]))
                  ...
                  if (typeof y.required_caps === "string")
                    y.required_caps = N.parseCaps(y.required_caps);
          ...
          e(
            ...
            function (l, c, f, e, a, s, t, d, m, i, u, h, p) {
              ...
              function v() {
                ...
                l.extend(this, {
                  ...
                  resize: function (e) {
                    ...
                    try {
                      ...
                      if (t.width > v.MAX_RESIZE_WIDTH || t.height > v.MAX_RESIZE_HEIGHT)
                        throw new f.ImageError(f.ImageError.MAX_RESOLUTION_ERR);
                  ...
                  embed: function (a, e) {
                    ...
                    try {
                      if (!(a = c.get(a)))
                        throw new f.DOMException(f.DOMException.INVALID_NODE_TYPE_ERR);
                      if (!this.size) throw new f.DOMException(f.DOMException.INVALID_STATE_ERR);
                      ...
                      if (
                        this.meta.thumb &&
                        this.meta.thumb.width >= t.width &&
                        this.meta.thumb.height >= t.height
                      )
                ...
                function i(e) {
                  ...
                  try {
                    if (e instanceof v) {
                      ...
                      if (!~l.inArray(e.type, ["image/jpeg", "image/png"]))
                        throw new f.ImageError(f.ImageError.WRONG_FORMAT);
                      r.apply(this, arguments);
                    } else if (l.inArray(t, ["blob", "file"]) !== -1)
                      i.call(this, new h(null, e), arguments[1]);
                    else if (t === "string")
                      if (e.substr(0, 5) === "data:")
                        i.call(
                          this,
                    ...
                    else if (t === "node" && e.nodeName.toLowerCase() === "img")
                ...
                function r(t, e) {
                  ...
                  if (t.isDetached()) {
                    ...
                    if (e && typeof e.required_caps === "string")
                ...
                var r = o.extend(
                  {
                    ...
                    drag_and_drop: i(
                      (function () {
                        ...
                        return (
                          ...
                          (s.browser !== "IE" || s.verComp(s.version, 9, ">"))
                        );
                      })(),
                    ),
                    filter_by_extension: i(
                      (function () {
                        return !(
                          (s.browser === "Chrome" && s.verComp(s.version, 28, "<")) ||
                          (s.browser === "IE" && s.verComp(s.version, 10, "<")) ||
                          (s.browser === "Safari" && s.verComp(s.version, 7, "<")) ||
                          (s.browser === "Firefox" && s.verComp(s.version, 37, "<"))
                        );
                      })(),
                    ),
                    ...
                    select_folder: function () {
                      return (
                        t.can("select_file") &&
                        ((s.browser === "Chrome" && s.verComp(s.version, 21, ">=")) ||
                          (s.browser === "Firefox" && s.verComp(s.version, 42, ">=")))
                      );
                    },
                    select_multiple: function () {
                      return (
                        t.can("select_file") &&
                        !(s.browser === "Safari" && s.os === "Windows") &&
                        !(
                          s.os === "iOS" &&
                          s.verComp(s.osVersion, "7.0.0", ">") &&
                          s.verComp(s.osVersion, "8.0.0", "<")
                        )
                      );
                    },
                    send_binary_string: i(
                    ...
                    summon_file_dialog: function () {
                      return (
                        t.can("select_file") &&
                        !(
                          (s.browser === "Firefox" && s.verComp(s.version, 4, "<")) ||
                          (s.browser === "Opera" && s.verComp(s.version, 12, "<")) ||
                          (s.browser === "IE" && s.verComp(s.version, 10, "<"))
                        )
                      );
                    },
              ...
              function i() {
                function e(t, i, n) {
                  ...
                  if (window.File.prototype.slice)
                    ...
                    (e = window.File.prototype.webkitSlice || window.File.prototype.mozSlice)
                  )
                    return e.call(t, i, n);
                  else return null;
                }
                ...
                d.extend(this, {
                  init: function (e) {
                    ...
                    r.innerHTML =
                      ...
                      (l.multiple && n.can("select_multiple") ? "multiple" : "") +
                      (l.directory && n.can("select_folder") ? "webkitdirectory directory" : "") +
                      (o ? ' accept="' + o.join(",") + '"' : "") +
                      " />";
                    t = m.get(n.uid);
                    d.extend(t.style, {
            ...
            function (e, h, p, t, g, i) {
              function n() {
                    ...
                    g.addEvent(
                      ...
                      function (e) {
                        ...
                        if (e.dataTransfer.items && e.dataTransfer.items[0].webkitGetAsEntry)
                          f(e.dataTransfer.items, function () {
                            t.files = n;
                            t.trigger("drop");
                          });
                        else {
                ...
                function s(e) {
                  ...
                  return (
                    p.inArray("Files", t) !== -1 ||
                    p.inArray("public.file-url", t) !== -1 ||
                    p.inArray("application/x-moz-file", t) !== -1
                  );
                }
                ...
                function f(e, t) {
                  ...
                  p.each(e, function (e) {
                    ...
                    if (t)
                      if (t.isFile) u(e.getAsFile(), t.fullPath);
                      else i.push(t);
                  });
                  if (i.length) d(i, t);
                  else t();
            ...
            function (e, d, m, h, p, g, v, x, w) {
              function t() {
                ...
                d.extend(this, {
                  send: function (n, i) {
                    var r = this,
                      e =
                        w.browser === "Mozilla" &&
                        w.verComp(w.version, 4, ">=") &&
                        w.verComp(w.version, 7, "<"),
                    ...
                    if (i instanceof g) {
                      ...
                      if (i.hasBlob())
                        if (i.getBlob().isDetached()) {
                          ...
                          (e || t) &&
                          d.typeOf(i.getBlob().getSource()) === "blob" &&
                          window.FileReader
                        ) {
                          l.call(r, n, i);
                          return;
                    ...
                    if (!d.isEmptyObj(n.headers))
                      d.each(n.headers, function (e, t) {
                        s.setRequestHeader(t, e);
                      });
                    if ("" !== n.responseType && "responseType" in s)
                      if ("json" === n.responseType && !w.can("return_response_type", "json"))
                        s.responseType = "text";
                      ...
                      switch (e) {
                        ...
                        case "json":
                          if (!w.can("return_response_type", "json"))
                            return s.status === 200 && !!window.JSON
                ...
                function c() {
                  if (
                    window.XMLHttpRequest &&
                    !(w.browser === "IE" && w.verComp(w.version, 8, "<"))
                  )
                ...
                return {
                  ...
                  get: function (e) {
                    ...
                    for (var i = 0, n = a.length; i < n; i++)
                      if (a[i].name === e.toUpperCase()) t.push(a[i].segment);
                    return t;
                  },
                  set: function (e, t) {
                    var i = [],
                ...
                v.extend(this, {
                  ...
                  GPS: function () {
                    ...
                    if (g.gpsIFD) {
                      ...
                      if (e.GPSVersionID && v.typeOf(e.GPSVersionID) === "array")
              ...
              function e(e) {
                ...
                (function () {
                  ...
                  for (t = 0; t < i.length; t++, e += 2)
                    if (i[t] != o.SHORT(e)) throw new u.ImageError(u.ImageError.WRONG_FORMAT);
                })();
          ...
          e(
            ...
            function (e, x, w, y, E, b, _, R, I, t) {
              function i() {
                ...
                x.extend(this, {
                  loadFromBlob: function (e) {
                    ...
                    if (!t.can("access_binary"))
                      throw new w.RuntimeError(w.RuntimeError.NOT_SUPPORTED_ERR);
                    s = e;
                    if (e.isDetached()) {
                      o = e.getSource();
                      h.call(this, o);
                  ...
                  loadFromImage: function (e, t) {
                    ...
                    h.call(this, t ? (o = e.getAsBinaryString()) : e.getAsDataURL());
                  },
                  getInfo: function () {
                    var e = this.getRuntime(),
                      t;
                    if (!r && o && e.can("access_image_binary")) r = new _(o);
                    t = {
                      width: c().width || 0,
                      height: c().height || 0,
                      type: s.type || I.getFileMime(s.name),
                      size: (o && o.length) || s.size || 0,
                      name: s.name || "",
                      meta: null,
                    };
                    if (l) {
                      t.meta = (r && r.meta) || this.meta || {};
                      if (t.meta && t.meta.thumb && !(t.meta.thumb.data instanceof E))
                        t.meta.thumb.data = new E(null, {
                          type: "image/jpeg",
                  ...
                  resize: function (e, t, i) {
                    ...
                    l = i.preserveHeaders;
                    var r =
                      this.meta && this.meta.exif && this.meta.exif.PixelXDimension == e.height;
                    if (!l || r) {
                  ...
                  getAsDataURL: function (e) {
                    ...
                    if (!u) return i.src;
                    f();
                    if ("image/jpeg" !== e) return a.toDataURL("image/png");
                    else
                      try {
                        return a.toDataURL("image/jpeg", t / 100);
                      } catch (e) {
                  ...
                  getAsBinaryString: function (e, t) {
                    if (!u) {
                      if (!o) o = d(n.getAsDataURL(e, t));
                      return o;
                    }
                    if ("image/jpeg" !== e) o = d(n.getAsDataURL(e, t));
                    else {
                      var i;
                      if (!t) t = 90;
                      f();
                      try {
                        i = a.toDataURL("image/jpeg", t / 100);
                      } catch (e) {
                        i = a.toDataURL("image/jpeg");
                      }
                      o = d(i);
                      if (r) {
                        o = r.stripHeaders(o);
                        if (l) {
                          if (r.meta && r.meta.exif)
                            r.setExif({
                ...
                function c() {
                  if (!a && !i) throw new w.ImageError(w.DOMException.INVALID_STATE_ERR);
                  return a || i;
                }
              ...
              function r(n) {
                ...
                c.call(
                  ...
                  },
                  {
                    ...
                    return_response_type: function (e) {
                      return a.arrayDiff(e, ["", "text", "json", "document"])
                        ? "browser"
                        : ["client", "browser"];
                    },
                    return_status_code: function (e) {
                ...
                if (i() < 11.3) {
                  if (MXI_DEBUG && s.debug.runtime)
                    s.log("\tFlash didn't meet minimal version requirement (11.3).");
                  this.mode = false;
                }
                a.extend(
                  this,
              ...
              var i = {
                ...
                getInfo: function () {
                  ...
                  if (
                    ...
                    t.meta.thumb &&
                    t.meta.thumb.data &&
                    !(e.meta.thumb.data instanceof r)
                  )
                    t.meta.thumb.data = new r(e.uid, t.meta.thumb.data);
                  return t;
                },
                getAsBlob: function (e, t) {
                  var i = this.getRuntime(),
                ...
                getInfo: function () {
                  ...
                  if (s.meta) {
                    ...
                    if (
                      ...
                      a.meta.thumb.data = new n(e.uid, a.meta.thumb.data);
                  }
              ...
              function t(e) {
                ...
                o.call(this, e, s, {
                  ...
                  filter_by_extension: i(
                    (function () {
                      return !(
                        (a.browser === "Chrome" && a.verComp(a.version, 28, "<")) ||
                        (a.browser === "IE" && a.verComp(a.version, 10, "<")) ||
                        (a.browser === "Safari" && a.verComp(a.version, 7, "<")) ||
                        (a.browser === "Firefox" && a.verComp(a.version, 37, "<"))
                      );
                    })(),
                  ),
                  resize_image: function () {
                  ...
                  summon_file_dialog: function () {
                    return (
                      t.can("select_file") &&
                      !(
                        (a.browser === "Firefox" && a.verComp(a.version, 4, "<")) ||
                        (a.browser === "Opera" && a.verComp(a.version, 12, "<")) ||
                        (a.browser === "IE" && a.verComp(a.version, 10, "<"))
                      )
                    );
                  },
            ...
            function (e, d, m, h, p, g, v) {
              function t() {
                ...
                function f() {
                  ...
                  if (v.browser === "IE" && v.verComp(v.version, 10, "<"))
                    m.extend(a.style, {
                ...
                m.extend(this, {
                  ...
                  setOption: function (e, t) {
                    ...
                    var n;
                    if (e == "accept")
                      l = t.mimes || g.extList2mimes(t, i.can("filter_by_extension"));
                    n = h.get(u);
            ...
            function (e, m, h, p, g, v, x, w) {
              function t() {
                ...
                m.extend(this, {
                        ...
                        function () {
                          ...
                          try {
                            e =
                              ...
                              f.contentDocument ||
                              window.frames[f.id].document;
                            if (/^4(0[0-9]|1[0-7]|2[2346])\s/.test(e.title))
                  ...
                  getResponse: function (e) {
                    if ("json" === e) {
                      if (m.typeOf(c) === "string" && !!window.JSON)
                        try {
                          return JSON.parse(
                  ...
                  abort: function () {
                    ...
                    if (f && f.contentWindow)
                      if (f.contentWindow.stop) f.contentWindow.stop();
                      else if (f.contentWindow.document.execCommand)
                        f.contentWindow.document.execCommand("Stop");
    ...
    (l.addFileFilter("mime_types", function (e, t, i) {
      ...
      (l.Uploader = function (e) {
        ...
        function d() {
          ...
          I.size === i
            ? (I.percent = D.length > 0 ? Math.ceil(100 * (I.uploaded / D.length)) : 0)
                      ...
                      U ||
                        ...
                        e.browse_button_active &&
                          ("mousedown" === t.type
                            ...
                            : "mouseup" === t.type && l.removeClass(i, e.browse_button_active)));
                    }),
                ...
                ("array" === l.typeOf(i) &&
                  ...
                  i.mime_types &&
                    ("string" === l.typeOf(i.mime_types) &&
                      (i.mime_types = t.core.utils.Mime.mimes2extList(i.mime_types)),
        ...
        function _(e, i) {
            ...
            i.status === l.UPLOADING &&
              ...
              d &&
                ...
                (e.settings.send_chunk_number
                  ? ((r.chunk = Math.ceil(p / d)), (r.chunks = Math.ceil(o.size / d)))
                  ...
                  : ((c = e.settings.max_retries),
                    g < o.size
                      ? (d.destroy(),
                        ...
                        "Android Browser" === l.ua.browser && e.trigger("UploadProgress", i))
                      : (i.loaded = i.size),
                    (d = m = null),
                    !p || p >= o.size
          ...
          (i.loaded && (p = i.loaded = d ? d * Math.floor(i.loaded / d) : 0),
            (o = i.getSource()),
            l.isEmptyObj(e.settings.resize) || -1 === l.inArray(o.type, ["image/jpeg", "image/png"])
              ? s()
          ...
          l.extend(this, {
            ...
            start: function () {
              this.state != l.STARTED &&
                ((this.state = l.STARTED), this.trigger("StateChanged"), a.call(this));
            },
            stop: function () {
